...
var riot=require("riot"),promise=require("promise"),fbRef=require("../../../firebase"),utils=require("../../../utils");module.exports=function(){function e(e){fbRef.child("membership/"+e+"/pending").on("value",i),fbRef.child("membership/"+e+"/member").on("value",i)}function i(e){var i=e.ref().key(),u=e.numChildren();return console.log(i,u),t[i]=[],e.exists()?void e.forEach(function(e){var o={uid:e.key()},t=n(e);e.val()instanceof Object&&(o=utils.extend(e.val(),o)),r(t,o,i,u)}):void o.trigger("memberlist_data",i,[])}function n(e){return new promise(function(i){fbRef.child("user/"+e.key()+"/name").on("value",function(e){i(e.exists()?e.val():"John Doe")})})}function r(e,i,n,r){e.then(function(e){i.name=e,t[n].push(i),r==t[n].length&&(console.log(t[n]),o.trigger("memberlist_data",n,t[n]))})}riot.observable(this);var o=this,t={};o.on("route",function(i,n,r){"project"!=i||r||e(n)})};
},{"../../../firebase":5,"../../../utils":38,"promise":43,"riot":49}],14:[function(require,module,exports){
var riot=require("riot"),promise=require("promise"),fbRef=require("../../../firebase");module.exports=function(){function e(e){console.log("compare to",e.newSign);var r;if(t.once("value",function(e){console.log(e.val())}),r&&r!=e.uid){var o='"'+e.newSign+'" is already used.';return l.trigger("alert",o,"warning"),!0}return console.log("all good"),l.trigger("alert_clear"),!1}function r(r){e(r)}function o(r){e(r)}function n(){}riot.observable(this);var i,t,l=this;l.on("memberrole_promote",r),l.on("memberrole_update",o),l.on("memberrole_demote",n),l.on("route",function(e,r,o){"project"!=e||o||i||(i=fbRef.child("membership/"+r+"/member"),t=fbRef.child("ringer/"+r))})};
...
var riot=require("riot");riot.tag("memberlist",'<h3>Members</h3> <p if="{ loading }">Loading…</p> <table> <tr each="{ item, i in pending }"> <td> <span>{ item.name }</span> <span riot-tag="membership" uid="{ item.uid }"></span> </td> </tr> </table> <table> <tr each="{ item, i in member }"> <td> <span>{ item.name } ({ item.role }<span if="{ item.sign }">, { item.sign }</span>)</span> <button type="button" onclick="{ parent.toggleMemberroleForm }">…</button> <div riot-tag="memberrole" data="{ item }"></div> </td> </tr> </table>',function(){var e=require("riotcontrol"),t=this;t.loading=!0,this.toggleMemberroleForm=function(e){t.tags.memberrole instanceof Array?t.tags.memberrole[e.item.i].toggleForm():t.tags.memberrole.toggleForm()}.bind(this),e.on("memberlist_data",function(e,i){t[e]=i,t.update({loading:!1})})});
},{"riot":49,"riotcontrol":50}],31:[function(require,module,exports){
var riot=require("riot");riot.tag("memberrole",'<form name="frmRoles" onsubmit="{ editMember }" if="{ showForm }"> <label><input type="checkbox" name="ringer" onclick="{ toggleTextfield }" __checked="{ isChecked }"> Ringer</label><br> <input type="text" name="sign" placeholder="Signature" value="{ opts.data.sign }" autocomplete="off" __disabled="{ isDisabled }"><br> <p if="{ signMissing }">Please add a ringer signature unique to this project.</p><br> <button type="submit">Update member</button> <button type="button" onclick="{ revoke }">Cancel membership</button> </form>',function(e){var i=require("riotcontrol"),o=(require("form-serialize"),require("../../../utils")),n=this;n.isChecked="ringer"==e.data.role,n.isDisabled=!n.isChecked,n.noChanges=!0,n.showForm=!1,this.toggleForm=function(){n.update({showForm:n.showForm?!1:!0})}.bind(this),this.toggleTextfield=function(e){n.isDisabled=!e.target.checked,n.isDisabled||setTimeout(function(){n.sign.focus()},1)}.bind(this),this.editMember=function(){var t={newRole:n.ringer.checked?"ringer":"assistant",newSign:n.ringer.checked?n.sign.value.toUpperCase():"",pid:n.parent.id},r=o.extend(e.data,t),s=e.data.sign?e.data.sign:"",a=e.data.role!=t.newRole,g=s!=t.newSign;return console.log("roleChanged %s, signChanged %s",a,g),console.dir(r),n.signMissing=!1,a||g&&t.newSign?"ringer"!=t.newRole||t.newSign?(!a&&g&&t.newSign&&(console.log("update"),i.trigger("memberrole_update",r)),a&&"ringer"==t.newRole&&t.newSign&&(console.log("promote"),i.trigger("memberrole_promote",r)),void(a&&"assistant"==t.newRole&&(console.log("demote"),i.trigger("memberrole_demote",r)))):(n.signMissing=!0,void n.sign.focus()):(console.log("nothing changed",r),void n.update({showForm:!1}))}.bind(this),this.revoke=function(){var o={pid:n.parent.id,uid:e.data.uid};i.trigger("membership_revoke",o)}.bind(this),i.on("memberrole_hide",function(){n.update({showForm:!1})})});
},{"../../../utils":38,"form-serialize":41,"riot":49,"riotcontrol":50}],32:[function(require,module,exports){
