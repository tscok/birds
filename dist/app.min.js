...
var riot=require("riot"),promise=require("promise"),fbRef=require("../../firebase"),utils=require("../../utils");module.exports=function(){function e(e){var o=e.key(),u=e.numChildren();n[o]=[],e.exists()||t.trigger("projects_data",o,n[o]),e.forEach(function(e){var t=r(e);i(t,o,u)})}function r(e){return new promise(function(r){fbRef.child("project/"+e.key()).on("value",function(e){if(e.exists()){var i=e.val();i.pid=e.key(),r(i)}})})}function i(e,r,i){e.then(function(e){n[r].push(e),i==n[r].length&&t.trigger("projects_data",r,n[r])})}riot.observable(this);var t=this,n={},o=["own","member","pending"];fbRef.onAuth(function(r){if(r)for(var i=0;i<o.length;i++)t.trigger("projects_clear",o[i]),fbRef.child("userproject/"+r.uid+"/"+o[i]).on("value",e)})};
