...
var riot=require("riot"),xhr=require("xhr"),fbRef=require("../../../firebase");module.exports=function(){function r(r,o,n){("project"==r||o||n)&&(t.trigger("ringform_clear"),i=fbRef.child("ringer/"+o).orderByChild("active").equalTo(!0),i.on("value",e))}function e(r){o=[],r.exists()&&(r.forEach(function(r){o.push({uid:r.key(),sign:r.val().sign})}),t.trigger("ringers_data",o))}riot.observable(this);var i,o,t=this;t.on("route",r)};
},{"../../../firebase":5,"riot":55,"xhr":57}],19:[function(require,module,exports){
...
var riot=require("riot"),xhr=require("xhr"),fbRef=require("../../../firebase");module.exports=function(){function e(e,t,o){("project"==e||t||o)&&(n||r())}function r(){var e={uri:"./artlista.min.json",headers:{"Content-Type":"application/json"},json:{}};xhr(e,function(e,r,t){!e&&200==r.statusCode&&t&&(n=t,console.log("species loaded"))})}function t(e){for(var r=[],t=new RegExp(e,"i"),s=0;s<n.length;s++)for(var a=0;a<i.length;a++)t.test(n[s][i[a]])&&r.push(n[s]);o.trigger("species_data",r.slice(0,6))}riot.observable(this);var n,o=this,i=["Artkod","ENnamn","SVnamn","VetNamn"];o.on("species_match",t),o.on("route",e)};
...
var riot=require("riot");riot.tag("species",'<label>Species</label><br> <input type="text" name="species" oninput="{ lookup }" onblur="{ delayClear }" autocomplete="off"> <div each="{ result }" onclick="{ specify }"> <span>{ Artkod } - { VetNamn }</span><br> <small>{ SVnamn } / { ENnamn }</small> </div>',function(){var e=require("riotcontrol"),t=this;this.specify=function(e){var i=e.item;t.species.value=i.Artkod,this.parent.setData(i)}.bind(this),this.lookup=function(){t.species.value.length>1?e.trigger("species_match",t.species.value):t.clearResult()}.bind(this),this.clearResult=function(){t.update({result:[]})}.bind(this),this.delayClear=function(){t.result.length&&setTimeout(function(){t.clearResult()},100)}.bind(this),e.on("species_data",function(e){t.update({result:e})})});
