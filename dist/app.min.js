...
var riot=require("riot"),fbRef=require("../../firebase"),utils=require("../../utils"),moment=require("moment");module.exports=function(){function t(t,r){if("project"==t&&r){e.trigger("project_clear");var a=r,o=fbRef.getAuth().uid;fbRef.child("project/"+a).on("value",function(t){var r={pid:a,isOwner:o==t.val().userId};projectData=utils.extend(t.val(),r);var i="YYYY-MM-DD",n=moment.unix(projectData.date.start),u=moment.unix(projectData.date.end);projectData.dateStart=n.format(i),projectData.dateEnd=u.format(i),e.trigger("project_data",projectData)})}}riot.observable(this);var e=this;e.on("route",t)};
