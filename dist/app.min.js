...
var riot=require("riot"),promise=require("promise"),riotcontrol=require("riotcontrol"),fbRef=require("./firebase");module.exports=function(){function r(r,e){return new promise(function(o){fbRef.child("membership/"+e+"/member/"+r).once("value",function(i){fbRef.child("project/"+e+"/userId").once("value",function(e){o({isMember:i.exists(),isOwner:e.val()==r})})})})}function e(e,i,t){var n=fbRef.getAuth()?fbRef.getAuth().uid:null;if(e&&!o[e])return void riotcontrol.trigger("alert",'404 - Route "'+e+'" not found.',"warning");if(riotcontrol.trigger("nav",n,i),"login"==e)return console.log("trigger route, login (shows login)"),void riotcontrol.trigger("route","login");if("logout"==e||!e||!n)return fbRef.unauth(),riot.route("login"),void console.log("unauth, route to login");if(o[e]&&o[e].uidReq){if("project"!=e)return void riotcontrol.trigger("route",e);if("project"==e&&!i)return void riot.route("profile");r(n,i).then(function(r){var o="Access denied. Membership required.";return r.isMember||r.isOwner?void riotcontrol.trigger("route",e,i,t):(riotcontrol.trigger("alert",o,"error"),void riot.route("profile"))})}}var o={login:{uidReq:!1},logout:{uidReq:!1},profile:{uidReq:!0},search:{uidReq:!0},create:{uidReq:!0},project:{uidReq:!0}};riot.route(e),riot.route.exec(e)};
...
var riot=require("riot"),promise=require("promise"),fbRef=require("../../../firebase"),utils=require("../../../utils");module.exports=function(){riot.observable(this)};
...
var riot=require("riot"),fbRef=require("../../firebase"),utils=require("../../utils"),moment=require("moment");module.exports=function(){function e(e){o=e,uid=fbRef.getAuth().uid,n.trigger("project_clear"),fbRef.child("project/"+o).on("value",t),fbRef.child("membership/"+o+"/member/"+uid).on("value",r)}function t(e){var t={pid:o,isOwner:fbRef.getAuth().uid==e.val().userId};a=utils.extend(e.val(),t);var r="YYYY-MM-DD",i=moment.unix(a.date.start),u=moment.unix(a.date.end);a.dateStart=i.format(r),a.dateEnd=u.format(r),n.trigger("project_data",a)}function r(e){u=e.val(),n.trigger("membership_data",u)}function i(t,r,i){return"project"==t&&r&&!i?o&&o==r?(n.trigger("project_data",a),void n.trigger("membership_data",u)):void e(r):void 0}riot.observable(this);var o,a,u,n=this;n.on("route",i)};
...
var riot=require("riot"),fbRef=require("../../firebase");module.exports=function(){function r(r){i.push(r,t)}function e(r){i.child(r.rsid).remove(t)}riot.observable(this);var i,o=this,t=function(r){r&&o.trigger("alert",r.message,"error")};o.on("ringlist_add",r),o.on("ringlist_remove",e)};
