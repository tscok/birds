...
var riot=require("riot"),fbRef=require("../../firebase");module.exports=function(){function i(i){o=i,s=fbRef.child("ringlist/"+o),s.orderByChild("size").on("value",r)}function r(i){g.length=0,i.forEach(function(i){g.push({rsid:i.key(),size:i.val().size,snid:i.val().snid})}),d.trigger("ringlist_data",g)}function e(i){s.push(i,l)}function t(i){s.child(i.rsid).remove(l)}function n(r,e){return"project"==r&&e?o==e&&g.length?(d.trigger("ringlist_hide"),void d.trigger("ringlist_data",g)):void i(e):void 0}riot.observable(this);var o,s,d=this,g=[],l=function(i){i&&d.trigger("alert",i.message,"error")};d.on("route",n),d.on("ringlist_add",e),d.on("ringlist_remove",t)};
