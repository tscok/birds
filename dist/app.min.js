...
},{"./tags/alert.tag":22,"./tags/create/create.tag":23,"./tags/dropdown.tag":24,"./tags/list.tag":25,"./tags/login.tag":26,"./tags/main.tag":27,"./tags/nav.tag":28,"./tags/profile/pending.tag":29,"./tags/profile/profile.tag":30,"./tags/profile/projects.tag":31,"./tags/project/member/memberlist.tag":32,"./tags/project/member/memberrole.tag":33,"./tags/project/member/membership.tag":34,"./tags/project/project.tag":35,"./tags/project/ring/ringform.tag":36,"./tags/project/ring/ringsize.tag":37,"./tags/search/join.tag":38,"./tags/search/search.tag":39,"riot":51}],4:[function(require,module,exports){
...
},{"firebase":42}],6:[function(require,module,exports){
var riot=require("riot"),fbRef=require("../../firebase");module.exports=function(){riot.observable(this);var e=this,t=function(e){var t=fbRef.getAuth().uid,r=e.country,i=fbRef.child("project"),o=fbRef.child("country/"+r.iso),c=fbRef.child("user/"+t+"/name"),u=fbRef.child("userproject/"+t+"/own");e.country=r.iso,e.userId=t;var s=i.push(e),a=s.key();c.once("value",function(e){i.child(a).update({userName:e.val()})}),u.child(a).set({title:e.title,site:e.site,date:e.date}),o.once("value",function(e){e.exists()||o.set({name:r.name}),o.child("project/"+a).set(!0)});var n="project/"+a;riot.route(n)};e.on("project_create",t)};
},{"../../firebase":5,"riot":51}],7:[function(require,module,exports){
...
},{"moment":44,"riot":51,"xhr":53}],8:[function(require,module,exports){
...
},{"../firebase":5,"promise":45,"riot":51}],9:[function(require,module,exports){
...
},{"riot":51}],10:[function(require,module,exports){
...
},{"../firebase":5,"riot":51}],11:[function(require,module,exports){
...
},{"../../firebase":5,"riot":51}],12:[function(require,module,exports){
var riot=require("riot");module.exports=function(){riot.observable(this)};
},{"riot":51}],13:[function(require,module,exports){
...
},{"../../firebase":5,"../../utils":40,"moment":44,"promise":45,"riot":51}],14:[function(require,module,exports){
...
},{"../../../firebase":5,"../../../utils":40,"promise":45,"riot":51}],15:[function(require,module,exports){
var riot=require("riot"),promise=require("promise"),fbRef=require("../../../firebase");module.exports=function(){function e(e){return new promise(function(i){t.once("value",function(n){var r;n.forEach(function(i){return i.val().sign==e.newSign?(r=i.key(),!0):void 0}),r&&r!=e.uid&&(u.trigger("alert",'"'+e.newSign+'" is assigned to another member.',"error"),i(!0)),i(!1)})})}function i(i){e(i).then(function(e){e||(o.child(i.uid).update({role:i.newRole,sign:i.newSign},l),t.child(i.uid).update({role:i.newRole,sign:i.newSign,active:!0},l))})}function n(i){e(i).then(function(e){e||(o.child(i.uid).update({sign:i.newSign},l),t.child(i.uid).update({sign:i.newSign},l))})}function r(e){console.log(e),o.child(e.uid).update({role:e.newRole},l),t.child(e.uid).update({role:e.newRole,active:!1},l)}riot.observable(this);var o,t,u=this,l=function(e){e?u.trigger("alert",e.message,"error"):u.trigger("memberrole_hide")};u.on("memberrole_promote",i),u.on("memberrole_update",n),u.on("memberrole_demote",r),u.on("route",function(e,i,n){"project"!=e||n||o||t||(o=fbRef.child("membership/"+i+"/member"),t=fbRef.child("ringer/"+i))})};
},{"../../../firebase":5,"promise":45,"riot":51}],16:[function(require,module,exports){
...
},{"../../../firebase":5,"promise":45,"riot":51}],17:[function(require,module,exports){
...
},{"../../firebase":5,"../../utils":40,"moment":44,"riot":51}],18:[function(require,module,exports){
...
},{"../../../firebase":5,"riot":51,"xhr":53}],19:[function(require,module,exports){
...
},{"../../../firebase":5,"riot":51}],20:[function(require,module,exports){
...
},{"../../firebase":5,"riot":51}],21:[function(require,module,exports){
...
},{"../../firebase":5,"../../utils":40,"moment":44,"riot":51}],22:[function(require,module,exports){
...
},{"riot":51,"riotcontrol":52}],23:[function(require,module,exports){
var riot=require("riot");riot.tag("create",'<form name="frmCreate" onsubmit="{ create }"> <h2>Create Project</h2> <label>Project title</label><br> <input type="text" name="title" placeholder="Project name" required><br> <label>Start date</label><br> <input type="date" name="dateStart" required><br> <label>End date</label><br> <input type="date" name="dateEnd" required><br> <label>Site name</label><br> <input type="text" name="site" placeholder="Site name" required><br> <label>Site location</label><br> <div id="mapCanvas"></div> <button type="button" onclick="{ resetMap }">Reset map</button><br> <label>Lat / Lng</label><br> <input type="text" name="latlng" placeholder="Click map to set…" disabled><br> <label>Country</label><br> <input type="hidden" name="countryIso"> <input type="hidden" name="countryName"> <input type="text" name="countryDisplay" placeholder="Click map to set…" disabled><br> <label>Timezone</label><br> <input type="text" name="tzId" placeholder="Click map to set…" disabled><br> <label>UTC Offset (minutes)</label><br> <input type="hidden" name="tzAbbr"> <input type="hidden" name="tzOffset"> <input type="text" name="tzDisplay" placeholder="Click map to set…" disabled><br> <label>Privacy</label><br> <input type="radio" name="privacy" value="public" checked> Public <input type="radio" name="privacy" value="private"> Private<br> <button type="submit">Create project</button> <button type="button" onclick="{ resetForm }">Reset</button> </form>',function(){var t=require("riotcontrol"),e=require("moment"),a=require("../../utils"),r=this;r.date={},this.checkDates=function(){return r.date.created=e().unix(),r.date.start=e(r.dateStart.value).unix(),r.date.end=e(r.dateEnd.value).unix(),r.date.start>=r.date.end}.bind(this),this.create=function(){if(r.checkDates()){var e="Start date cannot be later than, or equal to, End date.";return void t.trigger("alert",e,"warning")}var n={title:r.title.value,site:r.site.value,latlng:r.latlng.value,country:{iso:r.countryIso.value,name:r.countryName.value},timezone:{id:r.tzId.value,abbr:r.tzAbbr.value,offset:r.tzOffset.value},date:r.date,privacy:a.radioBtnVal("privacy")};t.trigger("alert_clear"),t.trigger("project_create",n),r.frmCreate.reset()}.bind(this),this.resetForm=function(){r.frmCreate.reset(),r.resetMap()}.bind(this),this.resetMap=function(){t.trigger("map_reset")}.bind(this),this.setMapData=function(t){var e=t.countryName&&t.countryIso?t.countryName+","+t.countryIso:"";r.countryIso.value=t.countryIso||null,r.countryName.value=t.countryName||null,r.latlng.value=t.latLng||null,r.countryDisplay.value=e,r.update()}.bind(this),this.setTzData=function(t){var e=t.offset&&t.abbr?t.offset+", "+t.abbr:"";r.tzId.value=t.tz||null,r.tzAbbr.value=t.abbr||null,r.tzOffset.value=t.offset||null,r.tzDisplay.value=e,r.update()}.bind(this),t.on("map_data",r.setMapData),t.on("map_tzData",r.setTzData),r.on("mount",function(){t.trigger("map_init")})});
},{"../../utils":40,"moment":44,"riot":51,"riotcontrol":52}],24:[function(require,module,exports){
...
},{"riot":51}],25:[function(require,module,exports){
...
},{"riot":51}],26:[function(require,module,exports){
...
},{"riot":51,"riotcontrol":52}],27:[function(require,module,exports){
...
},{"riot":51,"riotcontrol":52}],28:[function(require,module,exports){
...
},{"riot":51,"riotcontrol":52}],29:[function(require,module,exports){
...
},{"riot":51,"riotcontrol":52}],30:[function(require,module,exports){
var riot=require("riot");riot.tag("user","<h2>Profile</h2>",function(){});
},{"riot":51}],31:[function(require,module,exports){
...
},{"riot":51,"riotcontrol":52}],32:[function(require,module,exports){
...
},{"riot":51,"riotcontrol":52}],33:[function(require,module,exports){
var riot=require("riot");riot.tag("memberrole",'<button type="button" onclick="{ toggleForm }" style="position:absolute;right:0;top:0;">Edit</button> <form name="frmRoles" onsubmit="{ editMember }" if="{ showForm }"> <label><input type="checkbox" name="ringer" onclick="{ toggleTextfield }" __checked="{ isChecked }"> Ringer</label><br> <input type="text" name="sign" placeholder="Signature" autocomplete="off" __disabled="{ isDisabled }"><br> <p if="{ signMissing }">Please add a ringer signature unique to this project.</p><br> <button type="submit">Update member</button> <button type="button" onclick="{ revoke }">Cancel membership</button> </form>',function(e){var i=require("riotcontrol"),t=(require("form-serialize"),require("../../../utils")),n=this;n.isChecked="ringer"==e.data.role,n.isDisabled=!n.isChecked,n.noChanges=!0,n.showForm=!1,this.toggleForm=function(){n.showForm=n.showForm?!1:!0,n.sign.value=e.data.sign?e.data.sign:"",n.update()}.bind(this),this.toggleTextfield=function(e){n.isDisabled=!e.target.checked,n.isDisabled||setTimeout(function(){n.sign.focus()},1)}.bind(this),this.editMember=function(){var r={newRole:n.ringer.checked?"ringer":"assistant",newSign:n.ringer.checked?n.sign.value.toUpperCase():"",pid:n.parent.id},o=t.extend(e.data,r),s=e.data.sign?e.data.sign:"",a=e.data.role!=r.newRole,g=s!=r.newSign;return n.signMissing=!1,a||g&&r.newSign?"ringer"!=r.newRole||r.newSign?(!a&&g&&r.newSign&&i.trigger("memberrole_update",o),a&&"ringer"==r.newRole&&r.newSign&&i.trigger("memberrole_promote",o),void(a&&"assistant"==r.newRole&&i.trigger("memberrole_demote",o))):(n.signMissing=!0,void n.sign.focus()):void n.update({showForm:!1})}.bind(this),this.revoke=function(){var t={pid:n.parent.id,uid:e.data.uid};i.trigger("membership_revoke",t)}.bind(this),i.on("memberrole_hide",function(){n.update({showForm:!1})})});
},{"../../../utils":40,"form-serialize":43,"riot":51,"riotcontrol":52}],34:[function(require,module,exports){
...
},{"riot":51,"riotcontrol":52}],35:[function(require,module,exports){
...
},{"riot":51,"riotcontrol":52}],36:[function(require,module,exports){
...
},{"form-serialize":43,"riot":51,"riotcontrol":52}],37:[function(require,module,exports){
...
},{"riot":51,"riotcontrol":52}],38:[function(require,module,exports){
...
},{"moment":44,"riot":51,"riotcontrol":52}],39:[function(require,module,exports){
...
},{"../../utils":40,"moment":44,"riot":51,"riotcontrol":52}],40:[function(require,module,exports){
...
},{"global/window":54,"once":55,"parse-headers":59}],54:[function(require,module,exports){
(function (global){
...
},{"is-function":57}],57:[function(require,module,exports){
