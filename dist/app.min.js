...
var riot=require("riot"),promise=require("promise"),riotcontrol=require("riotcontrol"),fbRef=require("./firebase");module.exports=function(){function r(r,e){return new promise(function(o){fbRef.child("membership/"+e+"/member/"+r).once("value",function(i){fbRef.child("project/"+e+"/userId").once("value",function(e){o({isMember:i.exists(),isOwner:e.val()==r})})})})}function e(e,i,t){var n=fbRef.getAuth()?fbRef.getAuth().uid:null;if("login"==e)return void riotcontrol.trigger("route","login");if("logout"==e||!e||!n)return void riotcontrol.trigger("logout");if(!o[e])return void riotcontrol.trigger("alert",'404 - Route "'+e+'" not found.',"warning");if(o[e]&&o[e].uidReq){if("project"!=e)return void riotcontrol.trigger("route",e);if("project"==e&&!i)return void riot.route("profile");r(n,i).then(function(r){var o="Access denied. Membership required.";return r.isMember||r.isOwner?void riotcontrol.trigger("route",e,i,t):(riotcontrol.trigger("alert",o,"error"),void riot.route("profile"))})}}var o={login:{uidReq:!1},profile:{uidReq:!0},search:{uidReq:!0},create:{uidReq:!0},project:{uidReq:!0}};riot.route(e),riot.route.exec(e)};
},{"./firebase":5,"promise":52,"riot":58,"riotcontrol":59}],2:[function(require,module,exports){
var riotcontrol=require("riotcontrol");module.exports=function(){var r=require("./stores/login"),e=require("./stores/main"),o=require("./stores/nav"),t=require("./stores/profile/profile"),i=require("./stores/profile/projects"),n=require("./stores/profile/pending"),s=require("./stores/create/create"),d=require("./stores/create/map"),c=require("./stores/search/search"),a=require("./stores/search/join"),l=require("./stores/project/project"),u=require("./stores/project/member/memberlist"),p=require("./stores/project/member/membership"),q=require("./stores/project/member/memberrole"),w=require("./stores/project/ringlist"),S=require("./stores/project/ring/ringform"),m=require("./stores/project/ring/species"),j=require("./stores/project/ring/ringid"),g=require("./stores/project/ring/ringers");riotcontrol.addStore(new r),riotcontrol.addStore(new e),riotcontrol.addStore(new o),riotcontrol.addStore(new t),riotcontrol.addStore(new i),riotcontrol.addStore(new n),riotcontrol.addStore(new s),riotcontrol.addStore(new d),riotcontrol.addStore(new c),riotcontrol.addStore(new a),riotcontrol.addStore(new l),riotcontrol.addStore(new u),riotcontrol.addStore(new p),riotcontrol.addStore(new q),riotcontrol.addStore(new w),riotcontrol.addStore(new S),riotcontrol.addStore(new m),riotcontrol.addStore(new j),riotcontrol.addStore(new g)};
},{"./stores/create/create":6,"./stores/create/map":7,"./stores/login":8,"./stores/main":9,"./stores/nav":10,"./stores/profile/pending":11,"./stores/profile/profile":12,"./stores/profile/projects":13,"./stores/project/member/memberlist":14,"./stores/project/member/memberrole":15,"./stores/project/member/membership":16,"./stores/project/project":17,"./stores/project/ring/ringers":18,"./stores/project/ring/ringform":19,"./stores/project/ring/ringid":20,"./stores/project/ring/species":21,"./stores/project/ringlist":22,"./stores/search/join":23,"./stores/search/search":24,"riotcontrol":59}],3:[function(require,module,exports){
var riot=require("riot");module.exports=function(){require("./tags/main.tag"),require("./tags/nav.tag"),require("./tags/list.tag"),require("./tags/alert.tag"),require("./tags/dropdown.tag"),require("./tags/login.tag"),require("./tags/profile/profile.tag"),require("./tags/profile/projects.tag"),require("./tags/profile/pending.tag"),require("./tags/create/create.tag"),require("./tags/search/search.tag"),require("./tags/search/join.tag"),require("./tags/project/project.tag"),require("./tags/project/member/memberlist.tag"),require("./tags/project/member/memberrole.tag"),require("./tags/project/member/membership.tag"),require("./tags/project/ringlist.tag"),require("./tags/project/ring/ringform.tag"),require("./tags/project/ring/ringsize.tag"),require("./tags/project/ring/species.tag"),require("./tags/project/ring/ringid.tag"),require("./tags/project/ring/minmax.tag");riot.mount("app-main, app-nav")};
},{"./tags/alert.tag":25,"./tags/create/create.tag":26,"./tags/dropdown.tag":27,"./tags/list.tag":28,"./tags/login.tag":29,"./tags/main.tag":30,"./tags/nav.tag":31,"./tags/profile/pending.tag":32,"./tags/profile/profile.tag":33,"./tags/profile/projects.tag":34,"./tags/project/member/memberlist.tag":35,"./tags/project/member/memberrole.tag":36,"./tags/project/member/membership.tag":37,"./tags/project/project.tag":38,"./tags/project/ring/minmax.tag":39,"./tags/project/ring/ringform.tag":40,"./tags/project/ring/ringid.tag":41,"./tags/project/ring/ringsize.tag":42,"./tags/project/ring/species.tag":43,"./tags/project/ringlist.tag":44,"./tags/search/join.tag":45,"./tags/search/search.tag":46,"riot":58}],4:[function(require,module,exports){
var appStores=require("./app-stores")(),appTags=require("./app-tags")(),appRouter=require("./app-router")();
...
},{"firebase":49}],6:[function(require,module,exports){
var riot=require("riot"),fbRef=require("../../firebase");module.exports=function(){riot.observable(this);var e=this,r=function(r){r&&e.trigger("alert",r.message,"warning")},t=function(e){var t=fbRef.getAuth().uid,i=e.country,o=fbRef.child("project"),c=fbRef.child("country/"+i.iso),n=fbRef.child("user/"+t+"/name"),a=fbRef.child("userproject/"+t+"/own");e.country=i.iso,e.userId=t;var s=o.push(e,r),u=s.key(),f=fbRef.child("membership/"+u+"/member");n.once("value",function(e){var i=e.val();o.child(u).update({userName:i},r),f.child(t).set({name:i,role:"owner"},r)}),a.child(u).set({title:e.title,site:e.site,date:e.date},r),c.once("value",function(e){e.exists()||c.set({name:i.name},r),c.child("project/"+u).set(!0,r)});var l="project/"+u;riot.route(l)};e.on("create_project",t),e.on("route",function(r){"create"==r&&(e.trigger("create_reset"),e.trigger("map_reset"))})};
},{"../../firebase":5,"riot":58}],7:[function(require,module,exports){
var riot=require("riot"),xhr=require("xhr"),moment=require("moment");module.exports=function(){function t(){m=new google.maps.Map(document.getElementById("mapCanvas")),n(),google.maps.event.addListener(m,"click",function(t){s=t.latLng.lat()+","+t.latLng.lng(),e(t.latLng),a(t.latLng),r()})}function e(t){i&&o(),i=new google.maps.Marker({position:t,map:m})}function o(){i&&i.setMap(null)}function n(){o(),m.setOptions(c),g.trigger("map_data",{}),g.trigger("map_tzData",{})}function a(t){var e,o={};p.geocode({latLng:t},function(t,n){n==google.maps.GeocoderStatus.OK&&t[0]&&(e=t[t.length-1].address_components[0],o.latLng=s,o.countryIso=e.short_name,o.countryName=e.long_name,g.trigger("map_data",o))})}function r(){var t=moment().unix(),e="AIzaSyDU-QSezsFkEm9DikRmj7CH6RQnQIJhq4c",o="https://maps.googleapis.com/maps/api/timezone/json",n=o+"?location="+s+"&timestamp="+t+"&key="+e;xhr({url:n,json:{}},function(t,e,o){if(!t&&200==e.statusCode&&o){var n=(o.dstOffset+o.rawOffset)/60,a=o.timeZoneName.match(/\b(\w)/g).join(""),r=o.timeZoneId;g.trigger("map_tzData",{tz:r,abbr:a,offset:n})}})}riot.observable(this);var m,i,s,g=this,p=new google.maps.Geocoder,l=new google.maps.LatLng(63.27114510000001,12.449269500000014),c={zoom:8,center:l,mapTypeId:google.maps.MapTypeId.TERRAIN,streetViewControl:!1,zoomControl:!1,scaleControl:!1};g.on("map_init",t),g.on("map_reset",n)};
},{"moment":51,"riot":58,"xhr":60}],8:[function(require,module,exports){
var riot=require("riot"),fbRef=require("../firebase"),promise=require("promise");module.exports=function(){function o(o){return new promise(function(i,n){fbRef.authWithOAuthPopup(o,function(o,r){o&&n(o),r&&i(r)})})}function i(o){return new promise(function(i,n){fbRef.authWithPassword(o,function(o,r){o&&n(o),r&&i(r)})})}function n(o,i){o.then(function(o){console.log("login",o),u.trigger("login_success"),riot.route(i)},function(o){u.trigger("login_fail"),u.trigger("alert",o.message,"warning")})}function r(i){var r=o(i);n(r,"profile")}function e(o){var r=i(o);n(r,"profile")}function t(){fbRef.unauth(),riot.route("login")}riot.observable(this);var u=this;u.on("login",e),u.on("social_login",r),u.on("logout",t)};
},{"../firebase":5,"promise":52,"riot":58}],9:[function(require,module,exports){
...
},{"riot":58}],10:[function(require,module,exports){
...
},{"../firebase":5,"riot":58}],11:[function(require,module,exports){
var riot=require("riot"),fbRef=require("../../firebase");module.exports=function(){function e(e){e.forEach(function(e){fbRef.child("membership/"+e.key()+"/pending").on("value",function(n){var r=n.exists()?n.numChildren():0;i.trigger("pending_count_"+e.key(),r)})})}riot.observable(this);var i=this;fbRef.onAuth(function(i){i&&fbRef.child("userproject/"+i.uid+"/own").on("value",e)})};
},{"../../firebase":5,"riot":58}],12:[function(require,module,exports){
var riot=require("riot");module.exports=function(){riot.observable(this)};
},{"riot":58}],13:[function(require,module,exports){
var riot=require("riot"),promise=require("promise"),moment=require("moment"),fbRef=require("../../firebase"),utils=require("../../utils");module.exports=function(){function e(e){var i=e.key();r[i].length=0,e.forEach(function(e){var t=e.val();t.pid=e.key();var n=moment(),o=moment(n).unix(),a="YYYY-MM-DD";if("pending"==i){var d=moment.unix(t.date);t.pendingSince=d.from(n,!0)}else t.dateCreated=moment.unix(t.date.created).format(a),t.dateStart=moment.unix(t.date.start).format(a),t.dateEnd=moment.unix(t.date.end).format(a),t.dateStatus=o<=t.date.end?o<t.date.start?"Not started":"Active":"Completed";r[i].push(t)}),t.trigger("projects_data",i,r[i])}riot.observable(this);var t=this,r={own:[],member:[],pending:[]};fbRef.onAuth(function(r){r?(fbRef.child("userproject/"+r.uid+"/own").on("value",e),fbRef.child("userproject/"+r.uid+"/member").on("value",e),fbRef.child("userproject/"+r.uid+"/pending").on("value",e)):t.trigger("projects_clear")})};
},{"../../firebase":5,"../../utils":47,"moment":51,"promise":52,"riot":58}],14:[function(require,module,exports){
var riot=require("riot"),promise=require("promise"),fbRef=require("../../../firebase"),utils=require("../../../utils");module.exports=function(){function e(e){t=e,n.trigger("memberlist_clear"),fbRef.child("membership/"+t+"/pending").on("value",r),fbRef.child("membership/"+t+"/member").on("value",r)}function r(e){var r=e.key();m[r].length=0,e.forEach(function(e){var i=e.val();i.uid=e.key(),m[r].push(i)}),n.trigger("memberlist_data",r,m[r])}function i(r,i,o){return"project"==r&&i&&!o?t==i&&(m.pending.length||m.member.length)?(n.trigger("memberlist_data","pending",m.pending),void n.trigger("memberlist_data","member",m.member)):void e(i):void 0}riot.observable(this);var t,n=this,m={pending:[],member:[]};n.on("route",i)};
},{"../../../firebase":5,"../../../utils":47,"promise":52,"riot":58}],15:[function(require,module,exports){
var riot=require("riot"),promise=require("promise"),fbRef=require("../../../firebase");module.exports=function(){function e(e){o=fbRef.child("ringer/"+e.pid),t=fbRef.child("membership/"+e.pid+"/member");var r=e.newRole!=e.role,s=e.newSign?e.newSign!=e.sign:!1;if(!r&&!s)return void g.trigger("memberrole_hide");if(e.newRole="owner"==e.role?"owner":e.newRole,e.newSign&&n(e).then(function(n){if(n)return void g.trigger("alert",'"'+e.newSign+'" is assigned to another member!',"warning");if(r&&("ringer"==e.newRole||"owner"==e.newRole)){var o={role:e.newRole,sign:e.newSign},t={sign:e.newSign,active:!0};i(e.uid,o,t)}if(!r&&s){var o={sign:e.newSign},t={sign:e.newSign};i(e.uid,o,t)}}),r&&"assistant"==e.newRole){var l={role:e.newRole},a={active:!1};i(e.uid,l,a)}}function i(e,i,n){t.child(e).update(i,r),o.child(e).update(n,r)}function r(e){e?g.trigger("alert",e.message,"error"):(g.trigger("alert","Member updated!","success"),g.trigger("memberrole_hide"))}function n(e){return new promise(function(i){o.orderByChild("sign").equalTo(e.newSign).once("value",function(r){var n;r.exists()&&(r.forEach(function(e){n=e.key()}),n&&n!=e.uid&&i(!0)),i(!1)})})}riot.observable(this);var o,t,g=this;g.on("memberrole_edit",e)};
},{"../../../firebase":5,"promise":52,"riot":58}],16:[function(require,module,exports){
var riot=require("riot"),promise=require("promise"),fbRef=require("../../../firebase");module.exports=function(){function e(e){var i=fbRef.child("user/"+e+"/name");return new promise(function(e){i.once("value",function(i){e(i.val())})})}function i(i){var r=i.uid||fbRef.getAuth().uid,n=i.pid;delete i.pid,e(r).then(function(e){fbRef.child("membership/"+n+"/pending/"+r).set({name:e}),fbRef.child("userproject/"+r+"/pending/"+n).set(i)})}function r(e){var i=e.uid||fbRef.getAuth().uid;fbRef.child("userproject/"+i+"/pending/"+e.pid).remove(d),fbRef.child("membership/"+e.pid+"/pending/"+i).remove(d)}function n(i){var n=i.uid,t=i.pid;delete i.uid,delete i.pid,r({pid:t,uid:n}),e(n).then(function(e){fbRef.child("userproject/"+n+"/member/"+t).set(i),fbRef.child("membership/"+t+"/member/"+n).set({name:e,role:"assistant"})})}function t(e){var i=e.uid||fbRef.getAuth().uid;fbRef.child("userproject/"+i+"/member/"+e.pid).remove(d),fbRef.child("membership/"+e.pid+"/member/"+i).remove(d)}riot.observable(this);var f=this,d=function(e){e&&f.trigger("alert",e.message,"warning")};f.on("membership_request",i),f.on("membership_deny",r),f.on("membership_allow",n),f.on("membership_revoke",t)};
},{"../../../firebase":5,"promise":52,"riot":58}],17:[function(require,module,exports){
var riot=require("riot"),fbRef=require("../../firebase"),utils=require("../../utils"),moment=require("moment");module.exports=function(){function e(e){i=e,a.trigger("project_clear"),fbRef.child("project/"+i).on("value",t)}function t(e){var t={pid:i,isOwner:fbRef.getAuth().uid==e.val().userId};o=utils.extend(e.val(),t);var r="YYYY-MM-DD",n=moment.unix(o.date.start),u=moment.unix(o.date.end);o.dateStart=n.format(r),o.dateEnd=u.format(r),a.trigger("project_data",o)}function r(t,r,n){return"project"==t&&r&&!n?i==r&&o?void a.trigger("project_data",o):void e(r):void 0}riot.observable(this);var i,o,a=this;a.on("route",r)};
},{"../../firebase":5,"../../utils":47,"moment":51,"riot":58}],18:[function(require,module,exports){
var riot=require("riot"),fbRef=require("../../../firebase");module.exports=function(){function r(r){o=r;var i=fbRef.child("ringer/"+o).orderByChild("active").equalTo(!0);i.on("value",e)}function e(r){n.length=0,r.forEach(function(r){n.push({uid:r.key(),sign:r.val().sign})}),t.trigger("ringers_data",n)}function i(e,i,a){return"project"==e&&i&&a?o==i&&n.length?void t.trigger("ringers_data",n):void r(i):void 0}riot.observable(this);var o,t=this,n=[];t.on("route",i)};
},{"../../../firebase":5,"riot":58}],19:[function(require,module,exports){
var riot=require("riot"),fbRef=require("../../../firebase");module.exports=function(){function r(r,e,i){("project"==r||e||i)&&o.trigger("ringform_reset")}function e(r,e){console.log("saving",r,"data",e)}riot.observable(this);var o=this;o.on("route",r),o.on("ringform_save",e)};
},{"../../../firebase":5,"riot":58}],20:[function(require,module,exports){
var riot=require("riot"),fbRef=require("../../../firebase");module.exports=function(){riot.observable(this)};
},{"../../../firebase":5,"riot":58}],21:[function(require,module,exports){
var riot=require("riot"),xhr=require("xhr"),fbRef=require("../../../firebase");module.exports=function(){function e(){var e={uri:"./artlista.min.json",headers:{"Content-Type":"application/json"},json:{}};xhr(e,function(e,n,t){!e&&200==n.statusCode&&t&&(r=t,console.log("species loaded"))})}function n(e){for(var n=[],i=new RegExp(e,"i"),s=0;s<r.length;s++)for(var a=0;a<o.length;a++)i.test(r[s][o[a]])&&n.push(r[s]);t.trigger("species_data",n.slice(0,6))}riot.observable(this);var r,t=this,o=["Artkod","ENnamn","SVnamn","VetNamn"];fbRef.onAuth(function(n){n&&e()}),t.on("species_match",n)};
},{"../../../firebase":5,"riot":58,"xhr":60}],22:[function(require,module,exports){
var riot=require("riot"),fbRef=require("../../firebase");module.exports=function(){function i(i){o=i,s=fbRef.child("ringlist/"+o),s.orderByChild("size").on("value",r)}function r(i){l.length=0,i.forEach(function(i){l.push({rsid:i.key(),size:i.val().size,snid:i.val().snid})}),d.trigger("ringlist_data",l)}function e(i){s.push(i,u)}function n(i){s.child(i.rsid).remove(u)}function t(r,e){return"project"==r&&e?o==e&&l.length?void d.trigger("ringlist_data",l):void i(e):void 0}riot.observable(this);var o,s,d=this,l=[],u=function(i){i&&d.trigger("alert",i.message,"error")};d.on("route",t),d.on("ringlist_add",e),d.on("ringlist_remove",n)};
},{"../../firebase":5,"riot":58}],23:[function(require,module,exports){
var riot=require("riot"),fbRef=require("../../firebase");module.exports=function(){function e(e){function i(e){r.trigger("join_"+t,e.key(),e.exists())}var t=e,n=fbRef.getAuth().uid;pendingRef=fbRef.child("userproject/"+n+"/pending/"+t),memberRef=fbRef.child("userproject/"+n+"/member/"+t),pendingRef.on("value",i),memberRef.on("value",i)}riot.observable(this);var r=this;r.on("join_get_status",e)};
},{"../../firebase":5,"riot":58}],24:[function(require,module,exports){
var riot=require("riot"),utils=require("../../utils"),fbRef=require("../../firebase"),moment=require("moment");module.exports=function(){function e(e){a=fbRef.getAuth().uid,o=new RegExp(e.needle,"i"),s=e.category,c=[],l.once("value",function(e){e.forEach(function(e){"all"==s?r(e):t(e)}),c.sort(n),d.trigger("search_data",c)})}function r(e){for(var r,t=e.val(),n=0;n<f.length;n++)if(r=t[f[n]],r&&o.test(r)){i(t,e.key());break}}function t(e){var r=e.val(),t=r[s];t&&o.test(t)&&i(r,e.key())}function i(e,r){var t=e.userName,i={pid:r,isOwner:a===e.userId,userName:a===e.userId?t+" (You)":t,isActive:e.date.end>moment().unix()};c.push(utils.extend(e,i))}function n(e,r){return e.date.end>r.date.end?-1:e.date.end<r.date.end?1:0}function u(e){"search"==e&&d.trigger("search_clear")}riot.observable(this);var a,o,s,c,d=this,f=["title","site","userName"],l=fbRef.child("project").orderByChild("privacy").equalTo("public");d.on("search",e),d.on("route",u)};
},{"../../firebase":5,"../../utils":47,"moment":51,"riot":58}],25:[function(require,module,exports){
...
},{"riot":58,"riotcontrol":59}],26:[function(require,module,exports){
var riot=require("riot");riot.tag("create",'<form name="frmCreate" onsubmit="{ saveProject }"> <h2>Create Project</h2> <label>Project title</label><br> <input type="text" name="title" placeholder="Project name" autocomplete="off" required><br> <label>Start date</label><br> <input type="date" name="dateStart" required><br> <label>End date</label><br> <input type="date" name="dateEnd" required><br> <label>Site name</label><br> <input type="text" name="site" placeholder="Site name" autocomplete="off" required><br> <label>Site location</label><br> <div id="mapCanvas"></div> <button type="button" onclick="{ resetMap }">Reset map</button><br> <label>Lat / Lng</label><br> <input type="text" name="latlng" placeholder="Click map to set…" disabled><br> <label>Country</label><br> <input type="hidden" name="countryIso"> <input type="hidden" name="countryName"> <input type="text" name="countryDisplay" placeholder="Click map to set…" disabled><br> <label>Timezone</label><br> <input type="text" name="tzId" placeholder="Click map to set…" disabled><br> <label>UTC Offset (minutes)</label><br> <input type="hidden" name="tzAbbr"> <input type="hidden" name="tzOffset"> <input type="text" name="tzDisplay" placeholder="Click map to set…" disabled><br> <label>Privacy</label><br> <input type="radio" name="privacy" value="public" checked> Public <input type="radio" name="privacy" value="private"> Private<br> <button type="submit">Create project</button> <button type="button" onclick="{ resetForm }">Reset</button> </form>',function(){var e=require("riotcontrol"),t=require("moment"),a=require("../../utils"),r=this;r.date={},this.checkDates=function(){return r.date.created=t().unix(),r.date.start=t(r.dateStart.value).unix(),r.date.end=t(r.dateEnd.value).unix(),r.date.start>=r.date.end}.bind(this),this.saveProject=function(){if(r.checkDates()){var t="Start date cannot be later than, or equal to, End date.";return void e.trigger("alert",t,"warning")}var n={title:r.title.value,site:r.site.value,latlng:r.latlng.value,country:{iso:r.countryIso.value,name:r.countryName.value},timezone:{id:r.tzId.value,abbr:r.tzAbbr.value,offset:r.tzOffset.value},date:r.date,privacy:a.radioBtnVal("privacy")};e.trigger("alert_clear"),e.trigger("create_project",n)}.bind(this),this.resetForm=function(){r.frmCreate.reset(),r.resetMap()}.bind(this),this.resetMap=function(){e.trigger("map_reset")}.bind(this),this.setMapData=function(e){var t=e.countryName&&e.countryIso?e.countryName+","+e.countryIso:"";r.countryIso.value=e.countryIso||null,r.countryName.value=e.countryName||null,r.latlng.value=e.latLng||null,r.countryDisplay.value=t,r.update()}.bind(this),this.setTzData=function(e){var t=e.offset&&e.abbr?e.offset+", "+e.abbr:"";r.tzId.value=e.tz||null,r.tzAbbr.value=e.abbr||null,r.tzOffset.value=e.offset||null,r.tzDisplay.value=t,r.update()}.bind(this),e.on("map_data",r.setMapData),e.on("map_tzData",r.setTzData),e.on("create_reset",r.resetForm),r.on("mount",function(){e.trigger("map_init")})});
},{"../../utils":47,"moment":51,"riot":58,"riotcontrol":59}],27:[function(require,module,exports){
var riot=require("riot");riot.tag("dropdown",'<label>{ label }</label><br> <select id="select" name="{ opts.label }" __required="{ opts.require }"></select> <div id="options" style="display:none;"> <option value="">Select…</option> <yield></yield> </div>',function(e){var i=(require("riotcontrol"),require("../utils"));this.label=i.capitalize(e.label),this.select.innerHTML=this.options.innerHTML});
},{"../utils":47,"riot":58,"riotcontrol":59}],28:[function(require,module,exports){
var riot=require("riot");riot.tag("list",'<h3 if="{ opts.heading }">{ opts.heading }</h3> <ul if="{ opts.items.length }"> <li each="{ item, i in opts.items }"> <yield></yield> </li> </ul> <p if="{ opts.status && !opts.items.length }">{ opts.status }</p>',function(i){this.removeItem=function(t){var e=t.item.item,s=i.items,o=s.indexOf(e);s.splice(o,1)}.bind(this)});
},{"riot":58}],29:[function(require,module,exports){
...
},{"riot":58,"riotcontrol":59}],30:[function(require,module,exports){
var riot=require("riot");riot.tag("app-main",'<section riot-tag="alert"></section> <section riot-tag="login" if="{ route == \'login\' }"></section> <section riot-tag="search" if="{ route == \'search\' }"></section> <section riot-tag="create" if="{ route == \'create\' }"></section> <section riot-tag="profile" if="{ route == \'profile\' }"></section> <section riot-tag="projects" if="{ route == \'profile\' }"></section> <section riot-tag="project" if="{ route == \'project\' && id && !action }"></section> <section riot-tag="ringform" if="{ route == \'project\' && id && action }" action="{ action }"></section>',function(){var t=require("riotcontrol"),i=this;t.on("main",function(t,o,e){i.update({route:t,id:o,action:e})})});
},{"riot":58,"riotcontrol":59}],31:[function(require,module,exports){
var riot=require("riot");riot.tag("app-nav",'<div class="site-header" if="{ uid }"> <nav if="{ uid && !pid }" class="site-header__nav site-header__nav--left"> <a href="#create">Create Project</a> <a href="#search">Find Project</a> </nav> <nav if="{ uid && pid }" class="site-header__nav site-header__nav--left"> <a href="#project/{ pid }">Overview</a> <a href="#project/{ pid }/newring">New Ring</a> <a href="#project/{ pid }/control">Control</a> </nav> <nav if="{ uid }" class="site-header__nav site-header__nav--right"> <a href="#profile">{ name }</a> <a href="#logout">Log out</a> </nav> </div>',function(){var e=require("riotcontrol"),a=this;e.on("nav",function(e,i){a.update({pid:e,uid:i.uid,name:i.name||"Profile"})})});
},{"riot":58,"riotcontrol":59}],32:[function(require,module,exports){
var riot=require("riot");riot.tag("pending",'<span if="{ count }"> ({ count })</span>',function(n){var t=require("riotcontrol"),i=this;t.on("pending_count_"+n.pid,function(n){i.update({count:n})})});
},{"riot":58,"riotcontrol":59}],33:[function(require,module,exports){
var riot=require("riot");riot.tag("user","<h2>Profile</h2>",function(){});
},{"riot":58}],34:[function(require,module,exports){
var riot=require("riot");riot.tag("projects",'<h2>Projects</h2> <p if="{ loading }">Loading…</p> <div if="{ !loading }"> <list heading="Own" items="{ own }"> <span><a href="#project/{ item.pid }">{ item.title }</a>, { item.site }, { item.dateStart } &ndash; { item.dateEnd }</span> <span riot-tag="pending" pid="{ item.pid }"></span> </list> <p if="{ !own.length }">Project leader type? It\'s easy to <a href="#create">create a project</a> for others to join, or private if you prefer.</p> <list heading="Member" items="{ member }"> <span><a href="#project/{ item.pid }">{ item.title }</a>, { item.site }, { item.dateStatus }</span> <button type="button" onclick="{ parent.parent.leaveProject }">X</button> </list> <p if="{ !member.length }">No leader type? Know of an existing project? Try to <a href="#search">find it here</a>, then send a membership request.</p> <list heading="Pending" items="{ pending }" if="{ pending.length }"> <span>{ item.title }, { item.site }, { item.pendingSince }</span> <button type="button" onclick="{ parent.parent.removePending }">X</button> </list> </div>',function(){var e=require("riotcontrol"),t=this;t.loading=!0,this.leaveProject=function(t){var i=t.item.item;e.trigger("membership_revoke",i)}.bind(this),this.removePending=function(t){var i=t.item.item;e.trigger("membership_deny",i)}.bind(this),e.on("projects_data",function(e,i){t[e]=i,t.update({loading:!1})}),e.on("projects_clear",function(){t.update({own:[],member:[],pending:[]})})});
},{"riot":58,"riotcontrol":59}],35:[function(require,module,exports){
var riot=require("riot");riot.tag("memberlist",'<h3>Members</h3> <p if="{ loading }">Loading…</p> <list items="{ pending }"> <span>{ item.name }</span> <span riot-tag="membership" uid="{ item.uid }"></span> </list> <list items="{ member }"> <span>{ item.name } ({ item.role }<span if="{ item.sign }">, { item.sign }</span>)</span> <div riot-tag="memberrole" data="{ item }"></div> </list>',function(){var i=require("riotcontrol"),e=this;e.loading=!0,i.on("memberlist_data",function(i,t){e[i]=t,e.update({loading:!1})}),i.on("memberlist_clear",function(){e.update({pending:[],member:[]})})});
},{"riot":58,"riotcontrol":59}],36:[function(require,module,exports){
var riot=require("riot");riot.tag("memberrole",'<button type="button" onclick="{ toggleForm }">Edit</button> <form name="frmRoles" onsubmit="{ editMember }" if="{ showForm }"> <label><input type="checkbox" name="ringer" onclick="{ toggleTextfield }" __checked="{ isChecked }"> Ringer</label> <input type="text" name="sign" placeholder="Signature" autocomplete="off" oninput="{ clearHint }" __disabled="{ isDisabled }"><br> <p if="{ showHint }">Please add a signature for this ringer. Letters only, A-Z.</p><br> <button type="submit">Update member</button> <button type="button" onclick="{ revoke }" if="{ !isOwner }">Cancel membership</button> </form>',function(e){var i=require("riotcontrol"),t=require("../../../utils"),n=this;n.isChecked="ringer"==e.data.role,n.isDisabled=!n.isChecked,n.showForm=!1,this.toggleForm=function(){n.showForm=n.showForm?!1:!0,n.sign.value=e.data.sign?e.data.sign:"",n.isOwner="owner"==e.data.role,n.update()}.bind(this),this.toggleTextfield=function(e){n.isDisabled=!e.target.checked,n.isDisabled||setTimeout(function(){n.sign.focus()},1)}.bind(this),this.clearHint=function(){n.showHint=!1}.bind(this),this.editMember=function(){var r={newRole:n.ringer.checked?"ringer":"assistant",newSign:n.ringer.checked?n.sign.value.trim().toUpperCase():"",pid:n.parent.id},o=/^[A-Z]+$/.test(r.newSign);if("ringer"==r.newRole&&!o)return n.sign.value=r.newSign,n.showHint=!0,void n.sign.focus();var s=t.extend(e.data,r);i.trigger("memberrole_edit",s)}.bind(this),this.revoke=function(){var t={pid:n.parent.id,uid:e.data.uid};i.trigger("membership_revoke",t)}.bind(this),i.on("memberrole_hide",function(){n.update({showForm:!1})})});
},{"../../../utils":47,"riot":58,"riotcontrol":59}],37:[function(require,module,exports){
var riot=require("riot");riot.tag("membership",'<button onclick="{ allow }">Allow</button> <button onclick="{ deny }">Deny</button>',function(t){var i=require("riotcontrol");this.allow=function(){var e={title:this.parent.data.title,site:this.parent.data.site,date:this.parent.data.date,pid:this.parent.id,uid:t.uid};i.trigger("membership_allow",e)}.bind(this),this.deny=function(){var e={pid:this.parent.id,uid:t.uid};i.trigger("membership_deny",e)}.bind(this)});
},{"riot":58,"riotcontrol":59}],38:[function(require,module,exports){
var riot=require("riot");riot.tag("project",'<p if="{ loading }">Loading…</p> <div if="{ !loading }"> <h2>{ data.title }<span if="{ data.site }">, { data.site }</span></h2> <p>{ data.dateStart } &ndash; { data.dateEnd }</p> <memberlist if="{ data.isOwner }"></memberlist> <ringlist pid="{ data.pid }"></ringlist> </div>',function(){var a=require("riotcontrol"),t=this;t.loading=!0,a.on("project_data",function(a){t.update({data:a,loading:!1})}),a.on("project_clear",function(){t.update({data:null,loading:!0})})});
},{"riot":58,"riotcontrol":59}],39:[function(require,module,exports){
var riot=require("riot");riot.tag("minmax",'<label>{ label }</label><br> <input type="text" name="{ opts.label }" onblur="{ checkValue }" autocomplete="off"> <p if="{ showHint }"><yield></yield> {opts.min} - {opts.max} {opts.unit}.</p>',function(t){var e=(require("riotcontrol"),require("../../../utils")),i=this;i.label=e.capitalize(t.label),this.checkValue=function(e){var a=(e.target.name,e.target.value);i.showHint=t.min&&t.max&&a&&(a<t.min||a>t.max)?!0:!1}.bind(this)});
},{"../../../utils":47,"riot":58,"riotcontrol":59}],40:[function(require,module,exports){
var riot=require("riot");riot.tag("ringform",'<h2>{ opts.action == \'newring\' ? \'New Ring\' : \'Control\' }</h2> <form name="frmRing" onsubmit="{ saveRing }"> <div riot-tag="ringid" if="{ opts.action == \'control\' }"></div> <div riot-tag="species"></div> <div if="{ opts.action == \'newring\' }"> <div> <label>Ring #</label><br> <input riot-type={"number"} name="ringNumber" step="1" min="0" max="99" required> </div> <div riot-tag="ringsize"></div> </div> <div> <label>Net</label><br> <input type="text" name="net"> </div> <div riot-tag="dropdown" label="age"> <option each="{ val in parent.age }" value="{ val }">{ val }</option> </div> <div riot-tag="dropdown" label="sex"> <option each="{ val in parent.sex }" value="{ val }">{ val }</option> </div> <div> <label>PJM</label><br> <input riot-type={"number"} step="1" min="0" max="9" name="pjm"> </div> <div> <label>Fat</label><br> <input riot-type={"number"} step="1" min="0" max="9" name="fat"> </div> <div riot-tag="dropdown" label="sign" require="required"> <option each="{ parent.ringers }" value="{ sign }">{ sign }</option> </div> <div riot-tag="minmax" label="weight" min="{data.MinVikt}" max="{data.MaxVikt}" unit="g"> <span>Avg. weight is</span> </div> <div riot-tag="minmax" label="wing" min="{data.MinVinge}" max="{data.MaxVinge}" unit="mm"> <span>Avg. wing length is</span> </div> <div> <label>Primaries</label><br> <input type="text" name="primaries" autocomplete="off"> </div> <div> <label>Secondaries</label><br> <input type="text" name="secondaries" autocomplete="off"> </div> <div> <label>Comment</label><br> <textarea name="comment" autocomplete="off"></textarea> </div> <div> <button type="submit">Save</button> <button type="button" onclick="{ resetForm }">Reset</button> </div> </form>',function(i){var e=require("riotcontrol"),t=require("form-serialize"),n=this;n.sex=["F","M"],n.age=["1.0","2.0","2+","3+"],this.setRingformData=function(e){n.update({data:e}),"newring"==i.action&&n.tags.ringsize.setRingsize(e.Rtyp1.replace(",","."))}.bind(this),this.saveRing=function(){var r=t(n.frmRing,{hash:!0});if("newring"==i.action){if(!r.ringSize)return void e.trigger("alert","Ring size missing. Unable to create unique ring id.","error");r.ringNumber=parseInt(r.ringNumber)<10?"0"+r.ringNumber:r.ringNumber,r.id=r.snid?r.snid+r.ringNumber:r.ringNumber}r.species=r.species.toUpperCase(),delete r.ringNumber,delete r.ringSize,delete r.snid,e.trigger("ringform_save",i.action,r)}.bind(this),this.resetForm=function(){n.frmRing.reset()}.bind(this),e.on("ringers_data",function(i){n.update({ringers:i})}),e.on("ringform_reset",n.resetForm)});
},{"form-serialize":50,"riot":58,"riotcontrol":59}],41:[function(require,module,exports){
var riot=require("riot");riot.tag("ringid",'<label>Ring ID</label><br> <input type="text" name="ringid" onblur="{ lookup }" autocomplete="off" required>',function(){var i=require("riotcontrol"),r=this;this.lookup=function(){r.ringid.value.length&&i.trigger("ringid_match",r.ringid.value)}.bind(this),i.on("ringid_data",function(i){console.log("ringid",i)})});
},{"riot":58,"riotcontrol":59}],42:[function(require,module,exports){
var riot=require("riot");riot.tag("ringsize",'<input type="hidden" name="snid"> <div riot-tag="dropdown" label="ringSize" require="required"> <option each="{ ringsize }" value="{ size }">{ size }</option> </div>',function(){var i=require("riotcontrol"),n=this;this.setRingsize=function(e){parent.frmRing.ringSize.value=e;var r=parent.frmRing.ringSize.selectedIndex;if(-1==r){var t="Suggested ring size ("+e+") not listed in Rings.";return void i.trigger("alert",t,"warning")}n.setSnid(e)}.bind(this),this.setSnid=function(i){n.ringsize.forEach(function(e){e.size==i&&(n.snid.value=e.snid)})}.bind(this),i.on("ringlist_data",function(i){n.update({ringsize:i})})});
},{"riot":58,"riotcontrol":59}],43:[function(require,module,exports){
var riot=require("riot");riot.tag("species",'<label>Species</label><br> <input type="text" name="species" oninput="{ lookup }" onblur="{ delayClear }" autocomplete="off" required> <div each="{ result }" onclick="{ specify }" class="autocomplete"> <span>{ Artkod } - { VetNamn }</span><br><small>{ SVnamn } / { ENnamn }</small> </div>',function(){var e=require("riotcontrol"),t=this;this.specify=function(e){var i=e.item;console.log(i),t.species.value=i.Artkod,this.parent.setRingformData(i)}.bind(this),this.lookup=function(){t.species.value.length>1?e.trigger("species_match",t.species.value):t.clearResult()}.bind(this),this.clearResult=function(){t.update({result:[]})}.bind(this),this.delayClear=function(){t.species.value.length&&t.result.length&&setTimeout(function(){t.clearResult()},250)}.bind(this),e.on("species_data",function(e){t.update({result:e})})});
},{"riot":58,"riotcontrol":59}],44:[function(require,module,exports){
var riot=require("riot");riot.tag("ringlist",'<a href onclick="{ toggleForm }">Toggle Rings</a> <div if="{ showForm }"> <h3>Rings</h3> <div each="{ rings }"> <span>{ size }, { snid }</span> <button type="button" onclick="{ parent.removeSize }">X</button> </div> <form name="frmRinglist" onsubmit="{ saveSize }"> <input riot-type={"number"} step="0.5" name="size" placeholder="Ring size" autocomplete="off" required><br> <input type="text" name="snid" placeholder="Serial number" autocomplete="off" required><br> <button type="submit">Save</button> <button type="button" onclick="{ resetForm }">Cancel</button> </form> </div>',function(){var i=require("riotcontrol"),t=this;this.toggleForm=function(){t.showForm=!t.showForm}.bind(this),this.saveSize=function(){var e={size:t.size.value,snid:t.snid.value.toUpperCase()};i.trigger("ringlist_add",e),t.frmRinglist.reset(),t.size.focus()}.bind(this),this.removeSize=function(t){i.trigger("ringlist_remove",t.item)}.bind(this),this.resetForm=function(){t.frmRinglist.reset(),t.toggleForm()}.bind(this),i.on("ringlist_data",function(i){t.update({rings:i})}),i.on("ringlist_hide",function(){t.update({showForm:!1})})});
},{"riot":58,"riotcontrol":59}],45:[function(require,module,exports){
var riot=require("riot");riot.tag("join",'<span if="{ loading }">…</span> <span if="{ !loading }"> <span if="{ pending }">[Pending]</span> <span if="{ member }">[Member]</span> <button type="button" onclick="{ join }" if="{ !pending && !member }">Join</button> <button type="button" onclick="{ undo }" if="{ pending }">Undo</button> </span>',function(i){var n=require("riotcontrol"),t=require("moment"),e=this;e.loading=!0,this.join=function(){var o={pid:i.data.pid,title:i.data.title,site:i.data.site,date:t().unix()};n.trigger("membership_request",o),e.pending=!0}.bind(this),this.undo=function(){n.trigger("membership_deny",{pid:i.data.pid}),e.pending=!1}.bind(this),n.on("join_"+i.data.pid,function(i,n){e[i]=n,e.update({loading:!1})}),n.trigger("join_get_status",i.data.pid)});
},{"moment":51,"riot":58,"riotcontrol":59}],46:[function(require,module,exports){
var riot=require("riot");riot.tag("search",'<form name="frmSearch" onsubmit="{ find }"> <h2>Find project</h2> <input type="text" name="needle" placeholder="Search" autocomplete="off"> <button type="button" onclick="{ find }">OK</button><br> <label>Filter on</label> <select name="category" onchange="{ find }"> <option value="all">All</option> <option value="title">Title</option> <option value="site">Site</option> <option value="userName">User</option> </select> </form> <list heading="Search Results" items="{ result }" if="{ result.length }"> <span>{ item.title }</span><span>, { item.site }</span><br> <datetime>{ parent.parent.format(item.date.start) } &ndash; { parent.parent.format(item.date.end) }</datetime><br> <span>by { item.userName }</span> <join if="{ !item.isOwner && item.isActive }" data="{ item }"></join> </list>',function(){var e=require("riotcontrol"),t=(require("../../utils"),require("moment")),i=this;i.show=!1,this.find=function(){if(i.needle.value.length>1){var t={category:i.category.value,needle:i.needle.value};e.trigger("search",t)}}.bind(this),this.format=function(e){return t.unix(e).format("YYYY-MM-DD")}.bind(this),e.on("search_data",function(e){i.update({result:e})}),e.on("search_clear",function(){i.frmSearch.reset(),i.update({result:[]}),i.needle.focus()})});
},{"../../utils":47,"moment":51,"riot":58,"riotcontrol":59}],47:[function(require,module,exports){
var utils={};utils.extend=function(e,t){if(null==e||null==t)return e;for(key in t)t.hasOwnProperty(key)&&(e[key]=t[key]);return e},utils.capitalize=function(e){return e[0].toUpperCase()+e.substr(1)},utils.radioBtnVal=function(e){return document.querySelector("[name="+e+"]:checked").value},utils.setLocalUser=function(e){"undefined"!=typeof Storage&&localStorage.setItem("user",JSON.stringify(e))},utils.getLocalUser=function(e){var t=JSON.parse(localStorage.getItem("user"));return e?t[e]:t},utils.updateLocalUser=function(e,t){var r=utils.getLocalUser();r[e]=t,utils.setLocalUser(r)},module.exports=utils;
...
function serialize(e,r){"object"!=typeof r?r={hash:!!r}:void 0===r.hash&&(r.hash=!0);for(var t=r.hash?{}:"",a=r.serializer||(r.hash?hash_serializer:str_serialize),s=e.elements||[],c=Object.create(null),i=0;i<s.length;++i){var n=s[i];if((r.disabled||!n.disabled)&&n.name&&k_r_success_contrls.test(n.nodeName)&&!k_r_submitter.test(n.type)){var _=n.name,o=n.value;if("checkbox"!==n.type&&"radio"!==n.type||n.checked||(o=void 0),r.empty){if("checkbox"!==n.type||n.checked||(o=""),"radio"===n.type&&(c[n.name]||n.checked?n.checked&&(c[n.name]=!0):c[n.name]=!1),!o&&"radio"==n.type)continue}else if(!o)continue;if("select-multiple"!==n.type)t=a(t,_,o);else{o=[];for(var h=n.options,b=!1,l=0;l<h.length;++l){var u=h[l];u.selected&&(b=!0,t=a(t,_,u.value))}!b&&r.empty&&(t=a(t,_,""))}}}if(r.empty)for(var _ in c)c[_]||(t=a(t,_,""));return t}function hash_serializer(e,r,t){var a=has_array_brackets(r);if(a&&(r=r.replace(array_brackets_regex,"")),r in e){var s=e[r];Array.isArray(s)||(e[r]=[s]),e[r].push(t)}else has_object_brackets(r)?extract_from_brackets(e,r,t):e[r]=a?[t]:t;return e}function str_serialize(e,r,t){return t=t.replace(/(\r)?\n/g,"\r\n"),t=encodeURIComponent(t),t=t.replace(/%20/g,"+"),e+(e?"&":"")+encodeURIComponent(r)+"="+t}function has_object_brackets(e){return e.match(object_brackets_regex)}function has_array_brackets(e){return e.match(array_brackets_regex)}function matches_between_brackets(e){for(var r,t=new RegExp(object_brackets_regex),a=[];r=t.exec(e);)a.push(r[1]);return a}function extract_from_brackets(e,r,t){var a=r.match(brackeks_prefix_regex)[1];e[a]||(e[a]={});for(var s=e[a],c=matches_between_brackets(r),i=c.length,n=0;i>n;n++){var _=c[n],o=i===n+1;if(o){var h=s[_];h?(Array.isArray(h)||(s[_]=[h]),s[_].push(t)):s[_]=t}else s[_]=s[_]||{},s=s[_]}s=t}var k_r_submitter=/^(?:submit|button|image|reset|file)$/i,k_r_success_contrls=/^(?:input|select|textarea|keygen)/i,object_brackets_regex=/\[(.+?)\]/g,array_brackets_regex=/\[\]$/,brackeks_prefix_regex=/^(.+?)\[/;module.exports=serialize;
...
},{"./lib/core.js":53,"./lib/done.js":54,"./lib/es6-extensions.js":55,"./lib/node-extensions.js":56}],53:[function(require,module,exports){
...
},{"asap":57}],54:[function(require,module,exports){
...
},{"./core.js":53,"asap":57}],55:[function(require,module,exports){
...
},{"./core.js":53,"asap":57}],56:[function(require,module,exports){
...
},{"./core.js":53,"asap":57}],57:[function(require,module,exports){
(function (process){
...
},{"for-each":63,"trim":65}]},{},[4])
//# sourceMappingURL=data:application/json;charset:utf-8;base64,
