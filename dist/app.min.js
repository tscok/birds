...
var riot=require("riot"),promise=require("promise"),moment=require("moment"),fbRef=require("../../firebase"),utils=require("../../utils");module.exports=function(){function e(e){var i=e.key();t[i].length=0,e.forEach(function(e){var r=e.val();if(r.pid=e.key(),"pending"==i){var o=moment(),n=moment.unix(r.date);r.date=n.from(o,!0)}else r.date.created=moment.unix(r.date.created).format("ll"),r.date.start=moment.unix(r.date.start).format("ll"),r.date.end=moment.unix(r.date.end).format("ll");t[i].push(r)}),r.trigger("projects_data",i,t[i])}riot.observable(this);var r=this,t={own:[],member:[],pending:[]};fbRef.onAuth(function(t){t?(fbRef.child("userproject/"+t.uid+"/own").on("value",e),fbRef.child("userproject/"+t.uid+"/member").on("value",e),fbRef.child("userproject/"+t.uid+"/pending").on("value",e)):r.trigger("projects_clear")})};
},{"../../firebase":5,"../../utils":40,"moment":44,"promise":45,"riot":51}],14:[function(require,module,exports){
var riot=require("riot"),promise=require("promise"),fbRef=require("../../../firebase"),utils=require("../../../utils");module.exports=function(){function e(e){fbRef.child("membership/"+e+"/pending").on("value",i),fbRef.child("membership/"+e+"/member").on("value",i)}function i(e){var i=e.ref().key(),u=e.numChildren();return o[i]=[],e.exists()?void e.forEach(function(e){var t={uid:e.key()},o=r(e);e.val()instanceof Object&&(t=utils.extend(e.val(),t)),n(o,t,i,u)}):void t.trigger("memberlist_data",i,[])}function r(e){return new promise(function(i){fbRef.child("user/"+e.key()+"/name").on("value",function(e){i(e.exists()?e.val():"John Doe")})})}function n(e,i,r,n){e.then(function(e){i.name=e,o[r].push(i),n==o[r].length&&t.trigger("memberlist_data",r,o[r])})}riot.observable(this);var t=this,o={};t.on("route",function(i,r,n){"project"!=i||n||e(r)})};
...
var riot=require("riot"),promise=require("promise"),fbRef=require("../../../firebase");module.exports=function(){function e(e){var i=fbRef.child("user/"+e+"/name");return new promise(function(e){i.once("value",function(i){e(i.val())})})}function i(i){var r=i.uid||fbRef.getAuth().uid;e(r).then(function(e){fbRef.child("membership/"+i.pid+"/pending/"+r).set({name:e});var t={title:i.title,site:i.site,date:i.date};fbRef.child("userproject/"+r+"/pending/"+i.pid).set(t)})}function r(e){var i=e.uid||fbRef.getAuth().uid;fbRef.child("userproject/"+i+"/pending/"+e.pid).remove(m),fbRef.child("membership/"+e.pid+"/pending/"+i).remove(m)}function t(e){r(e),fbRef.child("userproject/"+e.uid+"/member/"+e.pid).set(!0),fbRef.child("membership/"+e.pid+"/member/"+e.uid).set({role:"assistant"})}function n(e){var i=e.uid||fbRef.getAuth().uid;fbRef.child("userproject/"+i+"/member/"+e.pid).remove(),fbRef.child("membership/"+e.pid+"/member/"+i).remove()}riot.observable(this);var f=this,m=function(e){e&&f.trigger("alert",e.message,"warning")};f.on("membership_request",i),f.on("membership_deny",r),f.on("membership_allow",t),f.on("membership_revoke",n)};
},{"../../../firebase":5,"promise":45,"riot":51}],17:[function(require,module,exports){
var riot=require("riot"),fbRef=require("../../firebase"),utils=require("../../utils"),moment=require("moment");module.exports=function(){function e(e){var r=fbRef.getAuth();fbRef.child("project/"+e).on("value",function(i){var o={pid:e,isOwner:r.uid==i.val().userId},n=utils.extend(i.val(),o),a=moment.unix(n.date.start),u=moment.unix(n.date.end);n.date.start=a.format("ll"),n.date.end=u.format("ll"),t.trigger("project_data",n)})}riot.observable(this);var t=this;t.on("route",function(t,r,i){"project"==t&&r&&!i&&e(r)})};
