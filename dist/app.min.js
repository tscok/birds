...
var riot=require("riot"),promise=require("promise"),fbRef=require("../../firebase"),utils=require("../../utils");module.exports=function(){function e(e){var o=e.key();i[o].length=0,e.forEach(function(e){var r=e.val();r.pid=e.key(),i[o].push(r)}),r.trigger("projects_data",o,i[o])}riot.observable(this);var r=this,i={own:[],member:[],pending:[]};fbRef.onAuth(function(i){i?(fbRef.child("userproject/"+i.uid+"/own").on("value",e),fbRef.child("userproject/"+i.uid+"/member").on("value",e),fbRef.child("userproject/"+i.uid+"/pending").on("value",e)):r.trigger("projects_clear")})};
},{"../../firebase":5,"../../utils":39,"promise":44,"riot":50}],14:[function(require,module,exports){
