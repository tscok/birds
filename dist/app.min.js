...
var riot=require("riot"),promise=require("promise"),fbRef=require("../../../firebase");module.exports=function(){function e(e){function i(){u.then(function(i){var t=i.list.indexOf(e.newSign);if(-1!=t&&i.source[e.uid]!=e.newSign){var l='The signature "'+e.newSign+'" is assigned to another member.';return void n.trigger("alert",l,"warning")}e.newRole!=e.role?o():e.newSign!=e.sign&&r()})}function o(){console.log("promote"),l.update({role:e.newRole,sign:e.newSign}),s.set(e.newSign)}function r(){console.log("update"),l.update({sign:e.newSign}),s.set(e.newSign)}function t(){console.log("demote"),l.update({role:e.newRole,sign:null})}console.log("edit member",e);var l=fbRef.child("membership/"+e.pid+"/member/"+e.uid),s=fbRef.child("ringer/"+e.pid+"/"+e.uid),u=new promise(function(n){var i=[];fbRef.child("ringer/"+e.pid).once("value",function(e){e.forEach(function(e){i.push(e.val())}),n({list:i,source:e.val()})})});"ringer"==e.newRole?i():e.newRole!=e.role&&t()}riot.observable(this);var n=this;n.on("memberrole_edit",e)};
