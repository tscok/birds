...
},{"./firebase":5,"promise":49,"riot":55,"riotcontrol":56}],2:[function(require,module,exports){
var riotcontrol=require("riotcontrol");module.exports=function(){var r=require("./stores/login"),e=require("./stores/main"),o=require("./stores/nav"),t=require("./stores/profile/profile"),i=require("./stores/profile/projects"),n=require("./stores/profile/pending"),s=require("./stores/create/create"),d=require("./stores/create/map"),c=require("./stores/search/search"),a=require("./stores/search/join"),l=require("./stores/project/project"),u=require("./stores/project/member/memberlist"),p=require("./stores/project/member/membership"),q=require("./stores/project/member/memberrole"),w=require("./stores/project/ring/ringsize"),S=require("./stores/project/ring/ringform"),m=require("./stores/project/ring/species"),j=require("./stores/project/ring/ringid");riotcontrol.addStore(new r),riotcontrol.addStore(new e),riotcontrol.addStore(new o),riotcontrol.addStore(new t),riotcontrol.addStore(new i),riotcontrol.addStore(new n),riotcontrol.addStore(new s),riotcontrol.addStore(new d),riotcontrol.addStore(new c),riotcontrol.addStore(new a),riotcontrol.addStore(new l),riotcontrol.addStore(new u),riotcontrol.addStore(new p),riotcontrol.addStore(new q),riotcontrol.addStore(new w),riotcontrol.addStore(new S),riotcontrol.addStore(new m),riotcontrol.addStore(new j)};
},{"./stores/create/create":6,"./stores/create/map":7,"./stores/login":8,"./stores/main":9,"./stores/nav":10,"./stores/profile/pending":11,"./stores/profile/profile":12,"./stores/profile/projects":13,"./stores/project/member/memberlist":14,"./stores/project/member/memberrole":15,"./stores/project/member/membership":16,"./stores/project/project":17,"./stores/project/ring/ringform":18,"./stores/project/ring/ringid":19,"./stores/project/ring/ringsize":20,"./stores/project/ring/species":21,"./stores/search/join":22,"./stores/search/search":23,"riotcontrol":56}],3:[function(require,module,exports){
var riot=require("riot");module.exports=function(){require("./tags/main.tag"),require("./tags/nav.tag"),require("./tags/list.tag"),require("./tags/alert.tag"),require("./tags/dropdown.tag"),require("./tags/login.tag"),require("./tags/profile/profile.tag"),require("./tags/profile/projects.tag"),require("./tags/profile/pending.tag"),require("./tags/create/create.tag"),require("./tags/search/search.tag"),require("./tags/search/join.tag"),require("./tags/project/project.tag"),require("./tags/project/member/memberlist.tag"),require("./tags/project/member/memberrole.tag"),require("./tags/project/member/membership.tag"),require("./tags/project/ring/ringsize.tag"),require("./tags/project/ring/ringform.tag"),require("./tags/project/ring/species.tag"),require("./tags/project/ring/ringid.tag");riot.mount("app-main, app-nav")};
},{"./tags/alert.tag":24,"./tags/create/create.tag":25,"./tags/dropdown.tag":26,"./tags/list.tag":27,"./tags/login.tag":28,"./tags/main.tag":29,"./tags/nav.tag":30,"./tags/profile/pending.tag":31,"./tags/profile/profile.tag":32,"./tags/profile/projects.tag":33,"./tags/project/member/memberlist.tag":34,"./tags/project/member/memberrole.tag":35,"./tags/project/member/membership.tag":36,"./tags/project/project.tag":37,"./tags/project/ring/ringform.tag":38,"./tags/project/ring/ringid.tag":39,"./tags/project/ring/ringsize.tag":40,"./tags/project/ring/species.tag":41,"./tags/search/join.tag":42,"./tags/search/search.tag":43,"riot":55}],4:[function(require,module,exports){
...
},{"firebase":46}],6:[function(require,module,exports){
var riot=require("riot"),fbRef=require("../../firebase");module.exports=function(){riot.observable(this);var e=this,t=function(e){var t=fbRef.getAuth().uid,r=e.country,i=fbRef.child("project"),o=fbRef.child("country/"+r.iso),c=fbRef.child("user/"+t+"/name"),u=fbRef.child("userproject/"+t+"/own");e.country=r.iso,e.userId=t;var a=i.push(e),n=a.key();c.once("value",function(e){i.child(n).update({userName:e.val()})}),u.child(n).set({title:e.title,site:e.site,date:e.date}),o.once("value",function(e){e.exists()||o.set({name:r.name}),o.child("project/"+n).set(!0)});var s="project/"+n;riot.route(s)};e.on("create_project",t),e.on("route",function(t){"create"==t&&(e.trigger("create_clear"),e.trigger("map_reset"))})};
},{"../../firebase":5,"riot":55}],7:[function(require,module,exports){
...
},{"moment":48,"riot":55,"xhr":57}],8:[function(require,module,exports){
...
},{"../firebase":5,"promise":49,"riot":55}],9:[function(require,module,exports){
...
},{"riot":55}],10:[function(require,module,exports){
...
},{"../firebase":5,"riot":55}],11:[function(require,module,exports){
...
},{"../../firebase":5,"riot":55}],12:[function(require,module,exports){
var riot=require("riot");module.exports=function(){riot.observable(this)};
},{"riot":55}],13:[function(require,module,exports){
...
},{"../../firebase":5,"../../utils":44,"moment":48,"promise":49,"riot":55}],14:[function(require,module,exports){
var riot=require("riot"),promise=require("promise"),fbRef=require("../../../firebase"),utils=require("../../../utils");module.exports=function(){function e(e){fbRef.child("membership/"+e+"/pending").on("value",r),fbRef.child("membership/"+e+"/member").on("value",r)}function r(e){var r=e.key();t[r].length=0,e.forEach(function(e){var i=e.val();i.uid=e.key(),t[r].push(i)}),i.trigger("memberlist_data",r,t[r])}riot.observable(this);var i=this,t={pending:[],member:[]};fbRef.onAuth(function(e){e||i.trigger("memberlist_clear")}),i.on("route",function(r,i,t){"project"==r&&i&&!t&&e(i)})};
},{"../../../firebase":5,"../../../utils":44,"promise":49,"riot":55}],15:[function(require,module,exports){
var riot=require("riot"),promise=require("promise"),fbRef=require("../../../firebase");module.exports=function(){function e(e){o=fbRef.child("ringer/"+e.pid),t=fbRef.child("membership/"+e.pid+"/member");var r=e.newRole!=e.role,s=e.newSign!=e.sign;if(!r&&!s)return void g.trigger("memberrole_hide");if(e.newSign&&n(e).then(function(n){if(n)return void g.trigger("alert",'"'+e.newSign+'" is assigned to another member!',"warning");if(r&&"ringer"==e.newRole){var o={role:e.newRole,sign:e.newSign},t={sign:e.newSign,active:!0};i(e.uid,o,t)}if(!r&&s){var o={sign:e.newSign},t={sign:e.newSign};i(e.uid,o,t)}}),r&&"assistant"==e.newRole){var a={role:e.newRole},u={active:!1};i(e.uid,a,u)}}function i(e,i,n){t.child(e).update(i,r),o.child(e).update(n,r)}function r(e){e?g.trigger("alert",e.message,"error"):(g.trigger("alert","Member updated!","success"),g.trigger("memberrole_hide"))}function n(e){return new promise(function(i){o.orderByChild("sign").equalTo(e.newSign).once("value",function(r){var n;r.exists()&&(r.forEach(function(e){n=e.key()}),n&&n!=e.uid&&i(!0)),i(!1)})})}riot.observable(this);var o,t,g=this;g.on("memberrole_edit",e)};
},{"../../../firebase":5,"promise":49,"riot":55}],16:[function(require,module,exports){
...
},{"../../../firebase":5,"promise":49,"riot":55}],17:[function(require,module,exports){
var riot=require("riot"),fbRef=require("../../firebase"),utils=require("../../utils"),moment=require("moment");module.exports=function(){function e(e){var i=fbRef.getAuth();fbRef.child("project/"+e).on("value",function(o){var a={pid:e,isOwner:i.uid==o.val().userId};t=utils.extend(o.val(),a);var n=moment.unix(t.date.start),u=moment.unix(t.date.end);t.dateStart=n.format("ll"),t.dateEnd=u.format("ll"),r.trigger("project_data",t)})}riot.observable(this);var t,r=this;r.on("route",function(t,i){"project"==t&&i?e(i):r.trigger("project_clear")})};
},{"../../firebase":5,"../../utils":44,"moment":48,"riot":55}],18:[function(require,module,exports){
var riot=require("riot"),fbRef=require("../../../firebase");module.exports=function(){function r(r,o,a){if("project"==r||o||a){if(t.trigger("ringform_clear"),n.length)return void t.trigger("ringers_data",n);i=fbRef.child("ringer/"+o).orderByChild("active").equalTo(!0),i.on("value",e)}}function e(r){n.length=0,r.forEach(function(r){n.push({uid:r.key(),sign:r.val().sign})}),t.trigger("ringers_data",n)}riot.observable(this);var i,t=this,n=[];t.on("route",r)};
},{"../../../firebase":5,"riot":55}],19:[function(require,module,exports){
var riot=require("riot"),fbRef=require("../../../firebase");module.exports=function(){riot.observable(this)};
},{"../../../firebase":5,"riot":55}],20:[function(require,module,exports){
var riot=require("riot"),fbRef=require("../../../firebase");module.exports=function(){function i(i,r){if("project"==i||r){if(t.trigger("ringsize_hide"),s.length)return void t.trigger("ringsize_data",s);o=fbRef.child("ringsize/"+r),o.orderByChild("size").on("value",e)}}function e(i){s.length=0,i.forEach(function(i){s.push({rsid:i.key(),size:i.val().size,snid:i.val().snid})}),t.trigger("ringsize_data",s)}function r(i){o.push(i,g)}function n(i){o.child(i.rsid).remove(g)}riot.observable(this);var o,t=this,s=[],g=function(i){i&&t.trigger("alert",i.message,"error")};t.on("route",i),t.on("ringsize_add",r),t.on("ringsize_remove",n)};
},{"../../../firebase":5,"riot":55}],21:[function(require,module,exports){
...
},{"../../../firebase":5,"riot":55,"xhr":57}],22:[function(require,module,exports){
...
},{"../../firebase":5,"riot":55}],23:[function(require,module,exports){
...
},{"../../firebase":5,"../../utils":44,"moment":48,"riot":55}],24:[function(require,module,exports){
...
},{"riot":55}],28:[function(require,module,exports){
...
},{"riot":55,"riotcontrol":56}],29:[function(require,module,exports){
...
},{"riot":55,"riotcontrol":56}],30:[function(require,module,exports){
...
},{"riot":55,"riotcontrol":56}],31:[function(require,module,exports){
...
},{"riot":55,"riotcontrol":56}],32:[function(require,module,exports){
var riot=require("riot");riot.tag("user","<h2>Profile</h2>",function(){});
},{"riot":55}],33:[function(require,module,exports){
var riot=require("riot");riot.tag("projects",'<h2>Projects</h2> <p if="{ loading }">Loading…</p> <list heading="Own" items="{ own }"> <span><a href="#project/{ item.pid }">{ item.title }</a>, { item.site }, { item.dateStart } &ndash; { item.dateEnd }</span> <span riot-tag="pending" pid="{ item.pid }"></span> </list> <list heading="Member" items="{ member }"> <span><a href="#project/{ item.pid }">{ item.title }</a>, { item.site }, { item.dateStatus }</span> <button type="button" onclick="{ parent.parent.leaveProject }">X</button> </list> <list heading="Pending" items="{ pending }"> <span>{ item.title }, { item.site }, { item.pendingSince }</span> <button type="button" onclick="{ parent.parent.removePending }">X</button> </list>',function(){var t=require("riotcontrol"),e=this;e.loading=!0,this.leaveProject=function(e){var i=e.item.item;t.trigger("membership_revoke",i)}.bind(this),this.removePending=function(e){var i=e.item.item;t.trigger("membership_deny",i)}.bind(this),t.on("projects_data",function(t,i){e[t]=i,e.update({loading:!1})}),t.on("projects_clear",function(){e.update({own:[],member:[],pending:[]})})});
},{"riot":55,"riotcontrol":56}],34:[function(require,module,exports){
...
},{"riot":55,"riotcontrol":56}],37:[function(require,module,exports){
var riot=require("riot");riot.tag("project",'<p if="{ loading }">Loading…</p> <div if="{ !loading }"> <h2>{ data.title }<span if="{ data.site }">, { data.site }</span></h2> <p>{ data.dateStart } &ndash; { data.dateEnd }</p> <memberlist if="{ data.isOwner }"></memberlist> <ringsize pid="{ data.pid }"></ringsize> </div>',function(){var a=require("riotcontrol"),t=this;t.loading=!0,a.on("project_data",function(a){t.update({data:a,loading:!1})}),a.on("project_clear",function(){t.update({data:null,loading:!0})})});
},{"riot":55,"riotcontrol":56}],38:[function(require,module,exports){
var riot=require("riot");riot.tag("ringform",'<h2>{ opts.action == \'newring\' ? \'New Ring\' : \'Control\' }</h2> <form name="frmRing"> <div riot-tag="ringid" if="{ opts.action == \'control\' }"></div> <div riot-tag="species"></div> <div if="{ opts.action == \'newring\' }"> <label>Ring #</label><br> <input riot-type={"number"} name="ringNumber" step="1" min="0" max="99"> </div> <input type="hidden" name="snid"> <div riot-tag="dropdown" label="ringSize" if="{ opts.action == \'newring\' }"> <option each="{ ringsize }" value="{ size }">{ size }</option> </div> <div> <label>Net</label><br> <input type="text" name="net"> </div> <div riot-tag="dropdown" label="age"> <option each="{ val in parent.age }" value="{ val }">{ val }</option> </div> <div riot-tag="dropdown" label="sex"> <option each="{ val in parent.sex }" value="{ val }">{ val }</option> </div> <div> <label>PJM</label><br> <input riot-type={"number"} step="1" min="0" max="9" name="pjm"> </div> <div> <label>Fat</label><br> <input riot-type={"number"} step="1" min="0" max="9" name="fat"> </div> <div riot-tag="dropdown" label="sign"> <option each="{ parent.ringers }" value="{ sign }">{ sign }</option> </div> <div> <label>Weight</label><br> <input type="text" name="weight" onblur="{ checkMinMax }"> <p if="{ minMax.weight.hint }">Average weight of this species is { minMax.weight.min }&ndash;{ minMax.weight.max } g.</p> </div> <div> <label>Wing length</label><br> <input type="text" name="wing" onblur="{ checkMinMax }"> <p if="{ minMax.wing.hint }">Average winglength of this species is { minMax.wing.min }&ndash;{ minMax.wing.max } mm.</p> </div> <div> <label>Primaries</label><br> <input type="text" name="primaries"> </div> <div> <label>Secondaries</label><br> <input type="text" name="secondaries"> </div> <div> <label>Comment</label><br> <textarea name="comment"></textarea> </div> <div> <button type="button" onclick="{ save }">Save</button> <button type="reset">Reset</button> </div> </form>',function(i){var e=require("riotcontrol"),n=require("form-serialize"),t=this;t.sex=["F","M"],t.age=["1.0","2.0","2+","3+"],this.checkMinMax=function(i){var e=i.target.name,n=i.target.value;n&&(n<t.minMax[e].min||n>t.minMax[e].max)&&(t.minMax[e].hint=!0)}.bind(this),this.setSpeciesData=function(i){t.minMax={weight:{min:i.MinVikt,max:i.MaxVikt,hint:!1},wing:{min:i.MinVinge,max:i.MaxVinge,hint:!1}},t.setRingsize(i.Rtyp1.replace(",","."))}.bind(this),this.setRingsize=function(n){if("control"!=i.action){t.frmRing.ringSize.value=n;var a=t.frmRing.ringSize.selectedIndex;if(-1==a){var r="Suggested ring size ("+n+") not listed in Ring Sizes.";return void e.trigger("alert",r,"warning")}t.setSnid(n)}}.bind(this),this.setSnid=function(i){t.ringsize.forEach(function(e){e.size==i&&(t.snid.value=e.snid)})}.bind(this),this.save=function(){var a=n(t.frmRing,{hash:!0});return"newring"!=i.action||a.ringSize?(a.species=a.species.toUpperCase(),a.ringNumber=parseInt(a.ringNumber)<10?"0"+a.ringNumber:a.ringNumber,a.id=a.snid?a.snid+a.ringNumber:a.ringNumber,delete a.ringNumber,delete a.ringSize,delete a.snid,void console.log("save",i.action,"data",a)):void e.trigger("alert","Ring size missing. Unable to create unique ring id.","error")}.bind(this),e.on("ringform_clear",function(){t.frmRing.reset()}),e.on("ringers_data",function(i){t.update({ringers:i})}),e.on("ringsize_data",function(i){t.update({ringsize:i})})});
},{"form-serialize":47,"riot":55,"riotcontrol":56}],39:[function(require,module,exports){
...
},{"riot":55,"riotcontrol":56}],40:[function(require,module,exports){
var riot=require("riot");riot.tag("ringsize",'<a href onclick="{ toggleForm }">Toggle Ring Sizes</a> <form name="frmRingsize" onsubmit="{ saveSize }" if="{ showForm }"> <list items="{ rings }"> <span>{ item.size }</span><span>{ item.snid }</span> <button type="button" onclick="{ parent.parent.removeSize }">X</button> </list> <input riot-type={"number"} step="0.5" name="size" placeholder="Ring size" required><br> <input type="text" name="snid" placeholder="Serial number" required><br> <button type="submit">Save</button> <button type="button" onclick="{ resetForm }">Cancel</button> </form>',function(){var e=require("riotcontrol"),i=this;this.toggleForm=function(){i.showForm=!i.showForm}.bind(this),this.saveSize=function(){var t={size:i.size.value,snid:i.snid.value.toUpperCase()};e.trigger("ringsize_add",t),i.frmRingsize.reset(),i.size.focus()}.bind(this),this.removeSize=function(i){e.trigger("ringsize_remove",i.item.item)}.bind(this),this.resetForm=function(){i.frmRingsize.reset(),i.toggleForm()}.bind(this),e.on("ringsize_data",function(e){i.update({rings:e})}),e.on("ringsize_hide",function(){i.update({showForm:!1})})});
},{"riot":55,"riotcontrol":56}],41:[function(require,module,exports){
var riot=require("riot");riot.tag("species",'<label>Species</label><br> <input type="text" name="species" oninput="{ lookup }" onblur="{ delayClear }" autocomplete="off" required> <div each="{ result }" onclick="{ specify }" class="autocomplete"> <span>{ Artkod } - { VetNamn }</span><br><small>{ SVnamn } / { ENnamn }</small> </div>',function(){var e=require("riotcontrol"),t=this;this.specify=function(e){var i=e.item;console.log(i),t.species.value=i.Artkod,this.parent.setSpeciesData(i)}.bind(this),this.lookup=function(){t.species.value.length>1?e.trigger("species_match",t.species.value):t.clearResult()}.bind(this),this.clearResult=function(){t.update({result:[]})}.bind(this),this.delayClear=function(){t.result.length&&setTimeout(function(){t.clearResult()},250)}.bind(this),e.on("species_data",function(e){t.update({result:e})})});
},{"riot":55,"riotcontrol":56}],42:[function(require,module,exports){
...
},{"moment":48,"riot":55,"riotcontrol":56}],43:[function(require,module,exports){
...
},{"../../utils":44,"moment":48,"riot":55,"riotcontrol":56}],44:[function(require,module,exports){
...
},{"./lib/core.js":50,"./lib/done.js":51,"./lib/es6-extensions.js":52,"./lib/node-extensions.js":53}],50:[function(require,module,exports){
...
},{"asap":54}],51:[function(require,module,exports){
...
},{"./core.js":50,"asap":54}],52:[function(require,module,exports){
...
},{"./core.js":50,"asap":54}],53:[function(require,module,exports){
...
},{"./core.js":50,"asap":54}],54:[function(require,module,exports){
(function (process){
