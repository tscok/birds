...
var riot=require("riot"),promise=require("promise"),fbRef=require("../../../firebase"),utils=require("../../../utils");module.exports=function(){function e(e){fbRef.child("membership/"+e+"/pending").on("value",r),fbRef.child("membership/"+e+"/member").on("value",r)}function r(e){var r=e.key();o[r].length=0,e.forEach(function(e){var i=e.val();i.uid=e.key(),o[r].push(i)}),i.trigger("memberlist_data",r,o[r])}riot.observable(this);var i=this,o={pending:[],member:[]};i.on("route",function(r,i,o){"project"==r&&i&&!o&&e(i)})};
