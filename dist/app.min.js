...
var riot=require("riot"),riotcontrol=require("riotcontrol"),fbRef=require("./firebase");module.exports=function(){function r(r){var o=fbRef.getAuth()?fbRef.getAuth().uid:null;return t[r].uidReq?!!o:!0}function o(o,e,i){return"logout"==o?void riotcontrol.trigger("logout"):void(o&&t[o]?r(o)?(riotcontrol.trigger("route",o,e,i),riotcontrol.trigger("alert_clear")):riot.route("login"):o&&!t[o]?riotcontrol.trigger("alert",'404 - Route "'+o+'" not found.',"warning"):riot.route("login"))}var t={login:{uidReq:!1},profile:{uidReq:!0},search:{uidReq:!0},create:{uidReq:!0},project:{uidReq:!0}};riot.route(o),riot.route.exec(o)};
},{"./firebase":5,"riot":49,"riotcontrol":50}],2:[function(require,module,exports){
var riotcontrol=require("riotcontrol");module.exports=function(){var r=require("./stores/login"),e=require("./stores/main"),o=require("./stores/nav"),t=require("./stores/profile/profile"),i=require("./stores/profile/projects"),n=require("./stores/create/create"),s=require("./stores/create/map"),c=require("./stores/search/search"),d=require("./stores/search/join"),a=require("./stores/project/project"),l=require("./stores/project/member/memberlist"),u=require("./stores/project/member/membership"),m=require("./stores/project/member/memberrole"),q=require("./stores/project/ring/ringsize"),w=require("./stores/project/ring/ringform");riotcontrol.addStore(new r),riotcontrol.addStore(new e),riotcontrol.addStore(new o),riotcontrol.addStore(new t),riotcontrol.addStore(new i),riotcontrol.addStore(new n),riotcontrol.addStore(new s),riotcontrol.addStore(new c),riotcontrol.addStore(new d),riotcontrol.addStore(new a),riotcontrol.addStore(new l),riotcontrol.addStore(new u),riotcontrol.addStore(new m),riotcontrol.addStore(new q),riotcontrol.addStore(new w)};
},{"./stores/create/create":6,"./stores/create/map":7,"./stores/login":8,"./stores/main":9,"./stores/nav":10,"./stores/profile/profile":11,"./stores/profile/projects":12,"./stores/project/member/memberlist":13,"./stores/project/member/memberrole":14,"./stores/project/member/membership":15,"./stores/project/project":16,"./stores/project/ring/ringform":17,"./stores/project/ring/ringsize":18,"./stores/search/join":19,"./stores/search/search":20,"riotcontrol":50}],3:[function(require,module,exports){
var riot=require("riot");module.exports=function(){require("./tags/main.tag"),require("./tags/nav.tag"),require("./tags/list.tag"),require("./tags/alert.tag"),require("./tags/dropdown.tag"),require("./tags/login.tag"),require("./tags/profile/profile.tag"),require("./tags/profile/projects.tag"),require("./tags/create/create.tag"),require("./tags/search/search.tag"),require("./tags/search/join.tag"),require("./tags/project/project.tag"),require("./tags/project/member/memberlist.tag"),require("./tags/project/member/memberrole.tag"),require("./tags/project/member/membership.tag"),require("./tags/project/ring/ringsize.tag"),require("./tags/project/ring/ringform.tag");riot.mount("app-main, app-nav")};
},{"./tags/alert.tag":21,"./tags/create/create.tag":22,"./tags/dropdown.tag":23,"./tags/list.tag":24,"./tags/login.tag":25,"./tags/main.tag":26,"./tags/nav.tag":27,"./tags/profile/profile.tag":28,"./tags/profile/projects.tag":29,"./tags/project/member/memberlist.tag":30,"./tags/project/member/memberrole.tag":31,"./tags/project/member/membership.tag":32,"./tags/project/project.tag":33,"./tags/project/ring/ringform.tag":34,"./tags/project/ring/ringsize.tag":35,"./tags/search/join.tag":36,"./tags/search/search.tag":37,"riot":49}],4:[function(require,module,exports){
...
},{"firebase":40}],6:[function(require,module,exports){
var riot=require("riot"),fbRef=require("../../firebase");module.exports=function(){riot.observable(this);var e=this,r=function(e){var r=fbRef.getAuth().uid,t=e.country,i=fbRef.child("project"),o=fbRef.child("country/"+t.id),c=fbRef.child("user/"+r+"/name"),u=fbRef.child("userproject/"+r+"/own");e.country=t.id,e.userId=r;var n=i.push(e),f=n.key();c.once("value",function(e){i.child(f).update({userName:e.val()})}),u.child(f).set(!0),o.once("value",function(e){e.exists()||o.set({name:t.name}),o.child("project/"+f).set(!0)});var a="project/"+f;riot.route(a)};e.on("project_create",r)};
},{"../../firebase":5,"riot":49}],7:[function(require,module,exports){
var riot=require("riot"),xhr=require("xhr"),moment=require("moment");module.exports=function(){function t(){m=new google.maps.Map(document.getElementById("mapCanvas")),n(),google.maps.event.addListener(m,"click",function(t){s=t.latLng.lat()+","+t.latLng.lng(),e(t.latLng),a(t.latLng),r()})}function e(t){i&&o(),i=new google.maps.Marker({position:t,map:m})}function o(){i&&i.setMap(null)}function n(){o(),m.setOptions(c),g.trigger("map_data",{}),g.trigger("map_tzData",{})}function a(t){var e,o={};p.geocode({latLng:t},function(t,n){n==google.maps.GeocoderStatus.OK&&t[0]&&(e=t[t.length-1].address_components[0],o.latLng=s,o.countryIso=e.short_name,o.countryName=e.long_name,g.trigger("map_data",o))})}function r(){var t=moment().unix(),e="AIzaSyDU-QSezsFkEm9DikRmj7CH6RQnQIJhq4c",o="https://maps.googleapis.com/maps/api/timezone/json",n=o+"?location="+s+"&timestamp="+t+"&key="+e;xhr({url:n,json:{}},function(t,e,o){if(!t&&200==e.statusCode&&o){var n=(o.dstOffset+o.rawOffset)/60,a=o.timeZoneName.match(/\b(\w)/g).join(""),r=o.timeZoneId;g.trigger("map_tzData",{tz:r,abbr:a,offset:n})}})}riot.observable(this);var m,i,s,g=this,p=new google.maps.Geocoder,l=new google.maps.LatLng(63.27114510000001,12.449269500000014),c={zoom:8,center:l,mapTypeId:google.maps.MapTypeId.TERRAIN,streetViewControl:!1,zoomControl:!1,scaleControl:!1};g.on("map_init",t),g.on("map_reset",n),g.on("route",function(t){"create"==t&&n()})};
},{"moment":42,"riot":49,"xhr":51}],8:[function(require,module,exports){
var riot=require("riot"),fbRef=require("../firebase"),promise=require("promise");module.exports=function(){function o(o){return new promise(function(n,i){fbRef.authWithOAuthPopup(o,function(o,t){o&&i(o),t&&n(t)})})}function n(o){return new promise(function(n,i){fbRef.authWithPassword(o,function(o,t){o&&i(o),t&&n(t)})})}function i(o,n){o.then(function(o){console.log("login",o),f.trigger("login_success"),riot.route(n)},function(o){f.trigger("login_fail"),f.trigger("alert",o.message,"warning")})}function t(n){var t=o(n);i(t,"profile")}function e(o){var t=n(o);i(t,"profile")}function r(){fbRef.unauth(),riot.route("login")}function u(o){"login"==o&&fbRef.getAuth()&&fbRef.unauth()}riot.observable(this);var f=this;f.on("login",e),f.on("social_login",t),f.on("logout",r),f.on("route",u)};
},{"../firebase":5,"promise":43,"riot":49}],9:[function(require,module,exports){
...
},{"riot":49}],10:[function(require,module,exports){
...
},{"../firebase":5,"riot":49}],11:[function(require,module,exports){
var riot=require("riot");module.exports=function(){riot.observable(this)};
},{"riot":49}],12:[function(require,module,exports){
var riot=require("riot"),promise=require("promise"),fbRef=require("../../firebase"),utils=require("../../utils");module.exports=function(){function e(e){var o=e.key(),u=e.numChildren();t[o]=[],e.exists()||n.trigger("projects_data",o,t[o]),e.forEach(function(e){var n=r(e);i(n,o,u)})}function r(e){return new promise(function(r){fbRef.child("project/"+e.key()).on("value",function(i){i.exists()&&fbRef.child("membership/"+e.key()+"/pending").on("value",function(e){var n=e.exists()?e.numChildren():0,t=i.val();t.pid=i.key(),t.pendingCount=n,r(t)})})})}function i(e,r,i){e.then(function(e){t[r].push(e),i==t[r].length&&n.trigger("projects_data",r,t[r])})}riot.observable(this);var n=this,t={},o=["own","member","pending"];fbRef.onAuth(function(r){if(r)for(var i=0;i<o.length;i++)n.trigger("projects_clear",o[i]),fbRef.child("userproject/"+r.uid+"/"+o[i]).on("value",e)})};
},{"../../firebase":5,"../../utils":38,"promise":43,"riot":49}],13:[function(require,module,exports){
var riot=require("riot"),promise=require("promise"),fbRef=require("../../../firebase"),utils=require("../../../utils");module.exports=function(){function e(e){var r=e;o.trigger("memberlist_clear"),fbRef.child("membership/"+r+"/pending").on("value",i),fbRef.child("membership/"+r+"/member").on("value",i)}function i(e){var i=e.ref().key(),t=e.numChildren();return u[i]=[],e.exists()?void e.forEach(function(e){var o={uid:e.key()},u=r(e);e.val()instanceof Object&&(o=utils.extend(e.val(),o)),n(u,o,i,t)}):void o.trigger("memberlist_data",i,[])}function r(e){return new promise(function(i){fbRef.child("user/"+e.key()+"/name").on("value",function(e){e.exists()&&i(e.val())})})}function n(e,i,r,n){e.then(function(e){i.name=e,u[r].push(i),n==u[r].length&&o.trigger("memberlist_data",r,u[r])})}function t(i,r,n){"project"!=i||n||e(r)}riot.observable(this);var o=this,u={};o.on("route",t)};
},{"../../../firebase":5,"../../../utils":38,"promise":43,"riot":49}],14:[function(require,module,exports){
var riot=require("riot"),promise=require("promise"),fbRef=require("../../../firebase");module.exports=function(){function e(e){function i(){l.then(function(i){var u=i.signatures.indexOf(e.newSign);return-1!=u&&i.ringers[e.uid].sign!=e.newSign?void n.trigger("alert",'Signature "'+e.newSign+'" already in use.',"warning"):void(e.newRole!=e.role?r():e.newSign!=e.sign&&o())})}function r(){t.child(e.uid).update({role:e.newRole,sign:e.newSign})}function o(){t.child(e.uid).update({sign:e.newSign})}function u(){t.child(e.uid).update({role:e.newRole})}var t=fbRef.child("membership/"+e.pid+"/member"),l=new promise(function(e){var n={},i=[];t.once("value",function(r){r.forEach(function(e){"ringer"==e.val().role&&(n[e.key()]=e.val(),i.push(e.val().sign))}),e({ringers:n,signatures:i})})});"ringer"==e.newRole?i():e.newRole!=e.role&&u()}riot.observable(this);var n=this;n.on("memberrole_edit",e)};
},{"../../../firebase":5,"promise":43,"riot":49}],15:[function(require,module,exports){
var riot=require("riot"),fbRef=require("../../../firebase");module.exports=function(){function e(e){var i=e.uid||fbRef.getAuth().uid;fbRef.child("membership/"+e.pid+"/pending/"+i).set(!0),fbRef.child("userproject/"+i+"/pending/"+e.pid).set(!0)}function i(e){var i=e.uid||fbRef.getAuth().uid;fbRef.child("userproject/"+i+"/pending/"+e.pid).remove(n),fbRef.child("membership/"+e.pid+"/pending/"+i).remove(n)}function r(e){i(e),fbRef.child("userproject/"+e.uid+"/member/"+e.pid).set(!0),fbRef.child("membership/"+e.pid+"/member/"+e.uid).set({role:"assistant"})}function t(e){var i=e.uid||fbRef.getAuth().uid;fbRef.child("userproject/"+i+"/member/"+e.pid).remove(),fbRef.child("membership/"+e.pid+"/member/"+i).remove()}function f(e,i){function r(){r.once("value",function(e){e.exists()||(o.trigger("alert",n,"error"),riot.route("profile"))})}if("project"==e){var t=i,f=fbRef.getAuth().uid,n="Access denied. Membership required.",r=fbRef.child("membership/"+t+"/member/"+f),d=fbRef.child("project/"+t+"/userId");d.once("value",function(e){e.val()!==f&&r()})}}riot.observable(this);var o=this,n=function(e){e&&o.trigger("alert",e.message,"warning")};o.on("membership_request",e),o.on("membership_deny",i),o.on("membership_allow",r),o.on("membership_revoke",t),o.on("route",f)};
},{"../../../firebase":5,"riot":49}],16:[function(require,module,exports){
var riot=require("riot"),fbRef=require("../../firebase"),utils=require("../../utils"),moment=require("moment");module.exports=function(){function e(e,r,i){if("project"==e&&!i){var o=fbRef.getAuth();fbRef.child("project/"+r).on("value",function(e){var i={pid:r,isOwner:o.uid==e.val().userId},a=utils.extend(e.val(),i),n=moment.unix(a.date.start),u=moment.unix(a.date.end);a.date.start=n.format("ll"),a.date.end=u.format("ll"),t.trigger("project_data",a)})}}riot.observable(this);var t=this;t.on("route",e)};
},{"../../firebase":5,"../../utils":38,"moment":42,"riot":49}],17:[function(require,module,exports){
var riot=require("riot"),xhr=require("xhr"),fbRef=require("../../../firebase");module.exports=function(){function r(){a.trigger("ringform_clear"),e()}function e(){if(!t){var r={uri:"./artlista.min.json",headers:{"Content-Type":"application/json"},json:{}};xhr(r,function(r,e,n){!r&&200==e.statusCode&&n&&(t=n)})}}function n(r){o=[];for(var e=new RegExp(r,"i"),n=0;n<t.length;n++)for(var i=0;i<s.length;i++)e.test(t[n][s[i]])&&o.push(t[n]);a.trigger("ringform_species_data",o.slice(0,10))}function i(e,n,i){"project"==e&&i&&r()}riot.observable(this);var t,o,a=this,s=["Artkod","ENnamn","SVnamn","VetNamn"];a.on("route",i),a.on("ringform_species",n)};
},{"../../../firebase":5,"riot":49,"xhr":51}],18:[function(require,module,exports){
var riot=require("riot"),fbRef=require("../../../firebase");module.exports=function(){function i(i,e,n){"project"!=i||n||(t.trigger("ringsize_hide"),o=fbRef.child("ringsize/"+e),o.orderByChild("size").on("value",r))}function r(i){var r=[],e=i.numChildren();return e?void i.forEach(function(i){r.push({rsid:i.key(),size:i.val().size,snid:i.val().snid}),e==r.length&&t.trigger("ringsize_data",r)}):void t.trigger("ringsize_data",r)}function e(i){o.push(i,s)}function n(i){o.child(i.rsid).remove(s)}riot.observable(this);var o,t=this,s=function(i){i&&t.trigger("alert",i.message,"error")};t.on("route",i),t.on("ringsize_add",e),t.on("ringsize_remove",n)};
},{"../../../firebase":5,"riot":49}],19:[function(require,module,exports){
var riot=require("riot"),fbRef=require("../../firebase");module.exports=function(){function e(e){i=e;for(var r,n=fbRef.getAuth().uid,f=0;f<t.length;f++)r=fbRef.child("userproject/"+n+"/"+t[f]+"/"+i),r.on("value",function(e){o(t[f],e)})}riot.observable(this);var i,r=this,t=["pending","member"],o=function(e,t){r.trigger("join_"+i,e,t.exists())};r.on("join_get_status",e)};
},{"../../firebase":5,"riot":49}],20:[function(require,module,exports){
...
},{"../../firebase":5,"../../utils":38,"moment":42,"riot":49}],21:[function(require,module,exports){
...
},{"riot":49,"riotcontrol":50}],22:[function(require,module,exports){
var riot=require("riot");riot.tag("create",'<form name="frmCreate" onsubmit="{ create }"> <h2>Create Project</h2> <label>Project title</label><br> <input type="text" name="title" placeholder="Project name" require><br> <label>Start date</label><br> <input type="date" name="dateStart" require><br> <label>End date</label><br> <input type="date" name="dateEnd" require><br> <label>Site name</label><br> <input type="text" name="site" placeholder="Site name"><br> <label>Site location</label><br> <div id="mapCanvas"></div> <button type="button" onclick="{ resetMap }">Reset map</button><br> <label>Lat / Lng</label><br> <input type="text" name="latlng" placeholder="Click map to set…" disabled><br> <label>Country</label><br> <input type="hidden" name="countryIso"> <input type="hidden" name="countryName"> <input type="text" name="countryDisplay" placeholder="Click map to set…" disabled><br> <label>Timezone</label><br> <input type="text" name="tzId" placeholder="Click map to set…" disabled><br> <label>UTC Offset (minutes)</label><br> <input type="hidden" name="tzAbbr"> <input type="hidden" name="tzOffset"> <input type="text" name="tzDisplay" placeholder="Click map to set…" disabled><br> <label>Privacy</label><br> <input type="radio" name="privacy" value="public" checked> Public <input type="radio" name="privacy" value="private"> Private<br> <button type="submit">Create project</button> <button type="button" onclick="{ resetForm }">Reset</button> </form>',function(){var t=require("riotcontrol"),e=require("../../utils"),a=require("moment"),r=this;r.date={},this.checkDates=function(){return r.date.created=a().unix(),r.date.start=a(r.dateStart.value).unix(),r.date.end=a(r.dateEnd.value).unix(),r.date.start>=r.date.end}.bind(this),this.create=function(){if(r.checkDates()){var a="Please correct; Start date cannot be later than, or equal to, End date.";return void t.trigger("alert",a,"warning")}var i={title:r.title.value,site:r.site.value,latlng:r.latlng.value,country:{id:r.countryIso.value,name:r.countryName.value},tz:{id:r.tzId.value,abbr:r.tzAbbr.value,offset:r.tzOffset.value},date:r.date,privacy:e.radioBtnVal("privacy")};t.trigger("alert_clear"),t.trigger("project_create",i),r.frmCreate.reset()}.bind(this),this.resetForm=function(){r.frmCreate.reset(),r.resetMap()}.bind(this),this.resetMap=function(){t.trigger("map_reset")}.bind(this),this.setMapData=function(t){var e=t.countryIso||"",a=t.countryName||"",i=t.latLng||"",n=a&&e?a+","+e:"";r.countryIso.value=e,r.countryName.value=a,r.countryDisplay.value=n,r.latlng.value=i}.bind(this),this.setTzData=function(t){var e=t.tz||"",a=t.abbr||"",i=t.offset||"",n=i&&a?i+", "+a:"";r.tzId.value=e,r.tzAbbr.value=a,r.tzOffset.value=i,r.tzDisplay.value=n}.bind(this),t.on("map_data",r.setMapData),t.on("map_tzData",r.setTzData),r.on("mount",function(){t.trigger("map_init")})});
},{"../../utils":38,"moment":42,"riot":49,"riotcontrol":50}],23:[function(require,module,exports){
var riot=require("riot");riot.tag("dropdown",'<label>{ capitalize(opts.select) }</label><br> <select name="{ opts.select }" onchange="{ setParentValue }" if="{ opts.objects }"> <option value="" selected>Select…</option> <option each="{ opts.items }" value="{ key }">{ val }</option> </select> <select name="{ opts.select }" onchange="{ setParentValue }" if="{ !opts.objects }"> <option value="" selected>Select…</option> <option each="{ val, i in opts.items }" value="{ val }">{ val }</option> </select>',function(){this.capitalize=function(e){return e[0].toUpperCase()+e.substr(1)}.bind(this)});
},{"riot":49}],24:[function(require,module,exports){
...
},{"riot":49}],25:[function(require,module,exports){
...
},{"riot":49,"riotcontrol":50}],26:[function(require,module,exports){
...
},{"riot":49,"riotcontrol":50}],27:[function(require,module,exports){
var riot=require("riot");riot.tag("app-nav",'<div class="site-header" if="{ uid }"> <nav if="{ uid && !pid }" class="site-header__nav site-header__nav--left"> <a href="#create">Create Project</a> <a href="#search">Find Project</a> </nav> <nav if="{ uid && pid }" class="site-header__nav site-header__nav--left"> <a href="#project/{ pid }">Overview</a> <a href="#project/{ pid }/newring">New Ring</a> <a href="#project/{ pid }/control">Control</a> </nav> <nav if="{ uid }" class="site-header__nav site-header__nav--right"> <a href="#profile">{ name }</a> <a href class="button" onclick="{ logout }">Log out</a> </nav> </div>',function(){var e=require("riotcontrol"),a=this;this.logout=function(){e.trigger("logout")}.bind(this),e.on("nav",function(e,i){a.update({pid:e,uid:i.uid,name:i.name||"Profile"})})});
},{"riot":49,"riotcontrol":50}],28:[function(require,module,exports){
var riot=require("riot");riot.tag("user","<h2>Profile</h2>",function(){});
},{"riot":49}],29:[function(require,module,exports){
var riot=require("riot");riot.tag("projects",'<h2>Projects</h2> <p if="{ loading }">Loading…</p> <list heading="Own" items="{ own }"> <a href="#project/{ item.pid }">{ item.title }<span if="{ item.site }">, { item.site }</span></a> <span if="{ item.pendingCount }"> ({ item.pendingCount })</span> </list> <list heading="Member" items="{ member }"> <a href="#project/{ item.pid }">{ item.title }<span if="{ item.site }">, { item.site }</span></a> <button type="button" onclick="{ parent.parent.leaveProject }">X</button> </list> <list heading="Pending" items="{ pending }"> <span>{ item.title }<span if="{ item.site }">, { item.site }</span></span> <button type="button" onclick="{ parent.parent.undoPending }">X</button> </list>',function(){var t=require("riotcontrol"),i=this;i.loading=!0,this.leaveProject=function(i){var e=i.item.item;t.trigger("membership_revoke",e)}.bind(this),this.undoPending=function(i){var e=i.item.item;t.trigger("membership_deny",e)}.bind(this),t.on("projects_data",function(t,e){i[t]=e,i.update({loading:!1})}),t.on("projects_clear",function(t){i[t]=[],i.update()})});
},{"riot":49,"riotcontrol":50}],30:[function(require,module,exports){
var riot=require("riot");riot.tag("memberlist",'<h3>Members</h3> <p if="{ loading }">Loading…</p> <list heading="Pending" items="{ pending }"> <span>{ item.name }</span> <membership uid="{ item.uid }"></membership> </list> <list heading="Member" items="{ member }"> <span>{ item.name } ({ item.role }<span if="{ item.sign }">, { item.sign }</span>)</span> <span riot-tag="memberrole" data="{ item }"></span> </list>',function(){var e=require("riotcontrol"),i=this;i.loading=!0,e.on("memberlist_data",function(e,n){i[e]=n,i.update({loading:!1})}),e.on("memberlist_clear",function(){i.update({pending:[],member:[]})})});
},{"riot":49,"riotcontrol":50}],31:[function(require,module,exports){
var riot=require("riot");riot.tag("memberrole",'<button onclick="{ toggleForm }">…</button> <div if="{ showForm }"> <form name="frmRoles" onsubmit="{ edit }"> <label><input type="checkbox" name="ringer" onclick="{ toggleTextfield }" __checked="{ isChecked }"> Ringer</label><br> <input type="text" name="sign" placeholder="Signature" value="{ signValue }" __disabled="{ isDisabled }"><br><br> <button type="submit">Update</button> <button type="button" onclick="{ revoke }">Revoke</button> </form> </div>',function(e){var i=require("riotcontrol"),t=require("../../../utils"),r=this;r.isChecked="ringer"==e.data.role,r.signValue=e.data.sign,r.isDisabled=!r.isChecked,r.showForm=!1,this.toggleForm=function(){r.update({showForm:r.showForm?!1:!0})}.bind(this),this.toggleTextfield=function(e){r.isDisabled=!e.target.checked,r.isDisabled||setTimeout(function(){r.sign.focus()},1)}.bind(this),this.edit=function(){var n={newRole:r.ringer.checked?"ringer":"assistant",newSign:r.ringer.checked?r.sign.value:"",pid:r.parent.id},o="Looks like you forgot to enter a signature.";return"ringer"!=n.newRole||n.newSign.length?(i.trigger("memberrole_edit",t.extend(e.data,n)),void i.trigger("alert_clear")):(i.trigger("alert",o,"warning"),void r.sign.focus())}.bind(this),this.revoke=function(){var t={pid:r.parent.id,uid:e.data.uid};i.trigger("membership_revoke",t)}.bind(this)});
},{"../../../utils":38,"riot":49,"riotcontrol":50}],32:[function(require,module,exports){
var riot=require("riot");riot.tag("membership",'<button onclick="{ allow }">Allow</button> <button onclick="{ deny }">Deny</button>',function(i){var t=require("riotcontrol"),n={pid:this.parent.id,uid:i.uid};this.allow=function(){t.trigger("membership_allow",n)}.bind(this),this.deny=function(){t.trigger("membership_deny",n)}.bind(this)});
},{"riot":49,"riotcontrol":50}],33:[function(require,module,exports){
var riot=require("riot");riot.tag("project",'<p if="{ loading }">Loading…</p> <div if="{ !loading }"> <h2>{ data.title }<span if="{ data.site }">, { data.site }</span></h2> <p>{ data.date.start } &ndash; { data.date.end }</p> <memberlist if="{ data.isOwner }"></memberlist> <ringsize pid="{ data.pid }"></ringsize> </div>',function(){var a=require("riotcontrol"),i=this;i.loading=!0,a.on("project_data",function(a){i.update({data:a,loading:!1})})});
},{"riot":49,"riotcontrol":50}],34:[function(require,module,exports){
var riot=require("riot");riot.tag("ringform",'<h2>{ opts.action == \'newring\' ? \'New Ring\' : \'Control\' }</h2> <form name="frmRing" onsubmit="{ save }"> <div if="{ opts.action == \'control\' }"> <label>Ring ID</label><br> <input type="text" name="ringid" placeholder="Ring ID" oninput="{ idLookup }"> </div> <label>Species</label><br> <input type="text" name="species" placeholder="Species" oninput="{ speciesLookup }" autocomplete="off"><br> <div each="{ specieslist }" onclick="{ setSpecies }"> <span>{ Artkod } - { VetNamn }<br><small>{ SVnamn }/{ ENnamn }</small></span> </div> <div if="{ opts.action == \'newring\' }"> <label>Ring #</label><br> <input riot-type={"number"} step="1" min="0" max="99" name="ring" placeholder="Ring #"><br> <dropdown select="size" items="{ size }" objects="{ true }"></dropdown><br> </div> <label>Net</label><br> <input type="text" name="net" placeholder="Net"><br> <dropdown select="age" items="{ age }"></dropdown><br> <dropdown select="sex" items="{ sex }"></dropdown><br> <label>PJM</label><br> <input riot-type={"number"} step="1" min="0" max="9" name="pjm"><br> <label>Fat</label><br> <input riot-type={"number"} step="1" min="0" max="9" name="fat"><br> <dropdown select="sign" items="{ sign }"></dropdown><br> <label>Weight</label><br> <input type="text" name="weight" placeholder="Weight" onblur="{ checkWeight }"> <p if="{ hint.weight }">Average weight of this species is { weight.min }&ndash;{ weight.max } g.</p><br> <label>Wing length</label><br> <input type="text" name="wingl" placeholder="Wing Length" onblur="{ checkWing }"> <p if="{ hint.wing }">Average winglength of this species is { wing.min }&ndash;{ wing.max } mm.</p><br> <label>Primaries</label><br> <input type="text" name="primaries" placeholder="Primaries"><br> <label>Secondaries</label><br> <input type="text" name="secondaries" placeholder="Secondaries"><br> <label>Comment</label><br> <textarea name="comment"></textarea><br> <button type="submit">Save</button> <button type="reset">Reset</button> </form>',function(e){var i=require("riotcontrol"),t=require("form-serialize"),n=this;n.sex=["F","M"],n.age=["1.0","2.0","2+","3+"],n.size=[{key:"abc123",val:"0,5"},{key:"wer456",val:"1"}],n.weight={},n.wing={},n.hint={weight:!1,wing:!1},this.checkWeight=function(e){var i=e.target.value;i&&(i<n.weight.min||i>n.weight.max)&&(n.hint.weight=!0)}.bind(this),this.checkWing=function(e){var i=e.target.value;i&&(i<n.wing.min||i>n.wing.max)&&(n.hint.wing=!0)}.bind(this),this.speciesLookup=function(){n.species.value.length>2?i.trigger("ringform_species",n.species.value):n.update({specieslist:[],weight:{},wing:{}})}.bind(this),this.setSpecies=function(e){var i=e.item;n.species.value=i.Artkod,n.weight={min:i.MinVikt,max:i.MaxVikt},n.wing={min:i.MinVinge,max:i.MaxVinge},n.update({specieslist:[]}),n.species.blur()}.bind(this),this.save=function(){var i=t(n.frmRing,{hash:!0});i.ring=parseInt(i.ring)<10?"0"+i.ring:i.ring,i.ring=i.size+i.ring,delete i.size,console.log("save",e.action,"data",i),n.frmRing.reset()}.bind(this),i.on("ringform_clear",function(){n.frmRing.reset()}),i.on("ringform_species_data",function(e){n.update({specieslist:e})})});
},{"form-serialize":41,"riot":49,"riotcontrol":50}],35:[function(require,module,exports){
var riot=require("riot");riot.tag("ringsize",'<a href onclick="{ toggleForm }">Toggle Ring Sizes</a> <form name="frmRingsize" onsubmit="{ add }" if="{ showForm }"> <list items="{ rings }"> <span>{ item.size }</span><span>{ item.snid }</span> <button type="button" onclick="{ parent.parent.remove }">X</button> </list> <input riot-type={"number"} step="0.5" name="size" placeholder="Ring size" required> <input type="text" name="snid" placeholder="Serial number" required> <button type="submit">Add</button> </form>',function(){var i=require("riotcontrol"),e=this;this.toggleForm=function(){e.showForm=!e.showForm}.bind(this),this.add=function(){var t={size:e.size.value,snid:e.snid.value.toUpperCase()};i.trigger("ringsize_add",t),e.frmRingsize.reset(),e.size.focus()}.bind(this),this.remove=function(e){i.trigger("ringsize_remove",e.item.item)}.bind(this),i.on("ringsize_data",function(i){e.update({rings:i})}),i.on("ringsize_hide",function(){e.update({showForm:!1})})});
},{"riot":49,"riotcontrol":50}],36:[function(require,module,exports){
var riot=require("riot");riot.tag("join",'<span if="{ loading }">…</span> <span if="{ !loading }"> <span if="{ pending }">[Pending]</span> <span if="{ member }">[Member]</span> <button type="button" onclick="{ join }" if="{ !pending && !member }">Join</button> <button type="button" onclick="{ undo }" if="{ pending }">Undo</button> </span>',function(n){var i=require("riotcontrol"),t=this;t.loading=!0,this.join=function(){i.trigger("membership_request",{pid:n.data.pid}),t.pending=!0}.bind(this),this.undo=function(){i.trigger("membership_deny",{pid:n.data.pid}),t.pending=!1}.bind(this),i.on("join_"+n.data.pid,function(n,i){t[n]=i,t.update({loading:!1})}),i.trigger("join_get_status",n.data.pid)});
},{"riot":49,"riotcontrol":50}],37:[function(require,module,exports){
...
},{"../../utils":38,"moment":42,"riot":49,"riotcontrol":50}],38:[function(require,module,exports){
