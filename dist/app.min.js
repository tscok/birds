...
var riotcontrol=require("riotcontrol");module.exports=function(){var r=require("./stores/login"),e=require("./stores/main"),o=require("./stores/nav"),t=require("./stores/profile/user"),i=require("./stores/profile/projectlist"),n=require("./stores/profile/pendingcount"),s=require("./stores/create/_create"),c=require("./stores/create/map"),d=require("./stores/search/_search"),a=require("./stores/search/join"),l=require("./stores/project/_project"),u=require("./stores/project/member/memberlist"),q=require("./stores/project/member/membership"),m=require("./stores/project/member/memberrole"),w=require("./stores/project/ring/ringsize"),S=require("./stores/project/ring/ringform");riotcontrol.addStore(new r),riotcontrol.addStore(new e),riotcontrol.addStore(new o),riotcontrol.addStore(new t),riotcontrol.addStore(new i),riotcontrol.addStore(new n),riotcontrol.addStore(new s),riotcontrol.addStore(new c),riotcontrol.addStore(new d),riotcontrol.addStore(new a),riotcontrol.addStore(new l),riotcontrol.addStore(new u),riotcontrol.addStore(new q),riotcontrol.addStore(new m),riotcontrol.addStore(new w),riotcontrol.addStore(new S)};
...
var riot=require("riot");module.exports=function(){require("./tags/main.tag"),require("./tags/nav.tag"),require("./tags/list.tag"),require("./tags/alert.tag"),require("./tags/dropdown.tag"),require("./tags/login.tag"),require("./tags/profile/_profile.tag"),require("./tags/profile/user.tag"),require("./tags/profile/projectlist.tag"),require("./tags/profile/pendingcount.tag"),require("./tags/create/_create.tag"),require("./tags/search/_search.tag"),require("./tags/search/join.tag"),require("./tags/project/_project.tag"),require("./tags/project/member/memberlist.tag"),require("./tags/project/member/memberrole.tag"),require("./tags/project/member/membership.tag"),require("./tags/project/ring/ringsize.tag"),require("./tags/project/ring/ringform.tag");riot.mount("app-main, app-nav")};
...
},{"../../../firebase":5,"riot":52,"xhr":54}],19:[function(require,module,exports){
