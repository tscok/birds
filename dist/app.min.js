...
var riot=require("riot"),promise=require("promise"),riotcontrol=require("riotcontrol"),fbRef=require("./firebase");module.exports=function(){function r(r,e){return new promise(function(o){fbRef.child("membership/"+e+"/member/"+r).once("value",function(i){fbRef.child("project/"+e+"/userId").once("value",function(e){o({isMember:i.exists(),isOwner:e.val()==r})})})})}function e(e,i,t){var u=fbRef.getAuth()?fbRef.getAuth().uid:null;if(e&&!o[e])return void riotcontrol.trigger("alert",'404 - Route "'+e+'" not found.',"warning");if(riotcontrol.trigger("nav",u,i),"login"==e)return void riotcontrol.trigger("route","login");if("logout"==e||!e||!u)return fbRef.unauth(),void riot.route("login");if(o[e]&&o[e].uidReq){if("project"!=e)return void riotcontrol.trigger("route",e);if("project"==e&&!i)return void riot.route("profile");r(u,i).then(function(r){var o="Access denied. Membership required.";return r.isMember||r.isOwner?void riotcontrol.trigger("route",e,i,t):(riotcontrol.trigger("alert",o,"error"),void riot.route("profile"))})}}var o={login:{uidReq:!1},logout:{uidReq:!1},profile:{uidReq:!0},search:{uidReq:!0},create:{uidReq:!0},project:{uidReq:!0}};riot.route(e),riot.route.exec(e)};
},{"./firebase":5,"promise":52,"riot":58,"riotcontrol":59}],2:[function(require,module,exports){
var riotcontrol=require("riotcontrol");module.exports=function(){var r=require("./stores/login"),e=require("./stores/main"),o=require("./stores/profile/profile"),t=require("./stores/profile/projects"),i=require("./stores/profile/pending"),n=require("./stores/create/create"),s=require("./stores/create/map"),c=require("./stores/search/search"),d=require("./stores/search/join"),l=require("./stores/project/project"),a=require("./stores/project/member/memberlist"),u=require("./stores/project/member/membership"),p=require("./stores/project/member/memberrole"),q=require("./stores/project/ringlist"),w=require("./stores/project/ring/ringform"),S=require("./stores/project/ring/species"),m=require("./stores/project/ring/ringid"),j=require("./stores/project/ring/ringers");riotcontrol.addStore(new r),riotcontrol.addStore(new e),riotcontrol.addStore(new o),riotcontrol.addStore(new t),riotcontrol.addStore(new i),riotcontrol.addStore(new n),riotcontrol.addStore(new s),riotcontrol.addStore(new c),riotcontrol.addStore(new d),riotcontrol.addStore(new l),riotcontrol.addStore(new a),riotcontrol.addStore(new u),riotcontrol.addStore(new p),riotcontrol.addStore(new q),riotcontrol.addStore(new w),riotcontrol.addStore(new S),riotcontrol.addStore(new m),riotcontrol.addStore(new j)};
},{"./stores/create/create":6,"./stores/create/map":7,"./stores/login":8,"./stores/main":9,"./stores/profile/pending":10,"./stores/profile/profile":11,"./stores/profile/projects":12,"./stores/project/member/memberlist":13,"./stores/project/member/memberrole":14,"./stores/project/member/membership":15,"./stores/project/project":16,"./stores/project/ring/ringers":17,"./stores/project/ring/ringform":18,"./stores/project/ring/ringid":19,"./stores/project/ring/species":20,"./stores/project/ringlist":21,"./stores/search/join":22,"./stores/search/search":23,"riotcontrol":59}],3:[function(require,module,exports){
var riot=require("riot");module.exports=function(){require("./tags/main.tag"),require("./tags/nav.tag"),require("./tags/list.tag"),require("./tags/alert.tag"),require("./tags/dropdown.tag"),require("./tags/button-input.tag"),require("./tags/login.tag"),require("./tags/profile/profile.tag"),require("./tags/profile/projects.tag"),require("./tags/profile/pending.tag"),require("./tags/create/create.tag"),require("./tags/search/search.tag"),require("./tags/search/join.tag"),require("./tags/project/project.tag"),require("./tags/project/member/memberlist.tag"),require("./tags/project/member/memberrole.tag"),require("./tags/project/member/membership.tag"),require("./tags/project/ringlist.tag"),require("./tags/project/ring/ringform.tag"),require("./tags/project/ring/ringsize.tag"),require("./tags/project/ring/species.tag"),require("./tags/project/ring/ringid.tag"),require("./tags/project/ring/minmax.tag");riot.mount("app-main, app-nav")};
},{"./tags/alert.tag":24,"./tags/button-input.tag":25,"./tags/create/create.tag":26,"./tags/dropdown.tag":27,"./tags/list.tag":28,"./tags/login.tag":29,"./tags/main.tag":30,"./tags/nav.tag":31,"./tags/profile/pending.tag":32,"./tags/profile/profile.tag":33,"./tags/profile/projects.tag":34,"./tags/project/member/memberlist.tag":35,"./tags/project/member/memberrole.tag":36,"./tags/project/member/membership.tag":37,"./tags/project/project.tag":38,"./tags/project/ring/minmax.tag":39,"./tags/project/ring/ringform.tag":40,"./tags/project/ring/ringid.tag":41,"./tags/project/ring/ringsize.tag":42,"./tags/project/ring/species.tag":43,"./tags/project/ringlist.tag":44,"./tags/search/join.tag":45,"./tags/search/search.tag":46,"riot":58}],4:[function(require,module,exports){
...
var riot=require("riot"),fbRef=require("../firebase"),promise=require("promise");module.exports=function(){function i(i){return new promise(function(n,o){fbRef.authWithOAuthPopup(i,function(i,r){i&&o(i),r&&n(r)})})}function n(i){return new promise(function(n,o){fbRef.authWithPassword(i,function(i,r){i&&o(i),r&&n(r)})})}function o(i,n){i.then(function(i){console.log("login",i),t.trigger("login_success"),riot.route(n)},function(i){t.trigger("login_fail"),t.trigger("alert",i.message,"warning")})}function r(n){var r=i(n);o(r,"profile")}function e(i){var r=n(i);o(r,"profile")}riot.observable(this);var t=this;t.on("login",e),t.on("social_login",r)};
},{"../firebase":5,"promise":52,"riot":58}],9:[function(require,module,exports){
var riot=require("riot");module.exports=function(){riot.observable(this);var r=this;r.on("route",function(i,t,o){r.trigger("main",i,t,o),r.trigger("main_"+i,t,o)})};
...
},{"riot":58}],12:[function(require,module,exports){
...
},{"../../firebase":5,"../../utils":47,"moment":51,"promise":52,"riot":58}],13:[function(require,module,exports){
var riot=require("riot"),promise=require("promise"),fbRef=require("../../../firebase"),utils=require("../../../utils");module.exports=function(){function e(e){t=e,m.trigger("memberlist_clear"),fbRef.child("membership/"+t+"/pending").on("value",r),fbRef.child("membership/"+t+"/member").on("value",r)}function r(e){var r=e.key();n[r].length=0,e.forEach(function(e){var i=e.val();i.uid=e.key(),n[r].push(i)}),m.trigger("memberlist_data",r,n[r])}function i(r,i,o){return"project"==r&&i&&!o?t&&t==i&&(n.pending.length||n.member.length)?(m.trigger("memberlist_data","pending",memberlist.pending),void m.trigger("memberlist_data","member",memberlist.member)):void e(i):void 0}riot.observable(this);var t,m=this,n={pending:[],member:[]};m.on("route",i)};
},{"../../../firebase":5,"../../../utils":47,"promise":52,"riot":58}],14:[function(require,module,exports){
...
},{"../../../firebase":5,"promise":52,"riot":58}],15:[function(require,module,exports){
...
var riot=require("riot"),fbRef=require("../../firebase"),utils=require("../../utils"),moment=require("moment");module.exports=function(){function e(e){i=e,uid=fbRef.getAuth().uid,u.trigger("project_clear"),fbRef.child("project/"+i).on("value",t)}function t(e){var t={pid:i,isOwner:fbRef.getAuth().uid==e.val().userId};o=utils.extend(e.val(),t);var r="YYYY-MM-DD",a=moment.unix(o.date.start),n=moment.unix(o.date.end);o.dateStart=a.format(r),o.dateEnd=n.format(r),u.trigger("project_data",o)}function r(t,r,a){return"project"==t&&r&&!a?i&&i==r&&o?void u.trigger("project_data",o):void e(r):void 0}riot.observable(this);var i,o,u=this;u.on("route",r)};
},{"../../firebase":5,"../../utils":47,"moment":51,"riot":58}],17:[function(require,module,exports){
...
},{"../../../firebase":5,"riot":58}],18:[function(require,module,exports){
...
},{"../../../firebase":5,"riot":58,"xhr":60}],21:[function(require,module,exports){
var riot=require("riot"),fbRef=require("../../firebase");module.exports=function(){function i(i){console.log("ringlist init"),t=fbRef.child("ringlist/"+i),t.orderByChild("size").on("value",o)}function o(i){l.length=0,i.forEach(function(i){l.push({rsid:i.key(),size:i.val().size,snid:i.val().snid})}),s.trigger("ringlist_data",l)}function r(i){t.push(i,g)}function n(i){t.child(i.rsid).remove(g)}function e(o,r,n){return"project"==o&&r?(n||(console.log("no action given"),s.trigger("ringlist_hide")),l.length?(console.log("ringlist has data"),void s.trigger("ringlist_data",l)):void i(r)):void console.log("not a project or ID missing")}riot.observable(this);var t,s=this,l=[],g=function(i){i&&s.trigger("alert",i.message,"error")};s.on("route",e),s.on("ringlist_add",r),s.on("ringlist_remove",n)};
},{"../../firebase":5,"riot":58}],22:[function(require,module,exports){
...
},{"../../firebase":5,"../../utils":47,"moment":51,"riot":58}],24:[function(require,module,exports){
...
},{"riot":58,"riotcontrol":59}],25:[function(require,module,exports){
var riot=require("riot");riot.tag("button-input",'<label>{ label }</label><br> <button type="button" each="{ buttons }" onclick="{ parent.select }" value="{ value }" class="{selected: selected }">{ label }</button> <input type="hidden" name="{ label }">',".selected { color: red; }",function(e){var t=require("riotcontrol"),l=this;l.buttons=e.options,l.label=e.label.toLowerCase(),this.deselectAll=function(){l.buttons.forEach(function(e){e.selected&&(e.selected=!1)})}.bind(this),this.select=function(e){var t=e.item.selected;l.deselectAll(),e.item.selected=t?!1:!0;var n=l[l.label],o=n.value,a=e.item.value;n.value=o!=a?a:""}.bind(this),t.on("route",function(e){"project"==e&&l[l.label].value&&(l[l.label].value=null,l.deselectAll())})});
...
var riot=require("riot");riot.tag("project",'<p if="{ loading }">Loading…</p> <div if="{ !loading }"> <h2>{ data.title }<span if="{ data.site }">, { data.site }</span></h2> <p>{ data.dateStart } &ndash; { data.dateEnd }</p> <p if="{ memberdata }">Your role in project: {memberdata.role} <span if="{memberdata.sign}">({memberdata.sign})</span></p> <memberlist if="{ data.isOwner }"></memberlist> <ringlist pid="{ data.pid }"></ringlist> </div>',function(){var a=require("riotcontrol"),t=this;t.loading=!0,a.on("project_data",function(a){t.update({data:a,loading:!1})}),a.on("project_clear",function(){t.update({data:null,loading:!0})}),a.on("membership_data",function(a){t.update({memberdata:a})})});
},{"riot":58,"riotcontrol":59}],39:[function(require,module,exports){
var riot=require("riot");riot.tag("minmax",'<label>{ label }</label><br> <input type="text" name="{ opts.label }" onblur="{ checkValue }" autocomplete="off"> <p if="{ showHint }"><yield></yield> {opts.min} - {opts.max} {opts.unit}.</p>',function(t){var e=(require("riotcontrol"),require("../../../utils")),i=this;i.label=e.capitalize(t.label),this.checkValue=function(e){var a=(e.target.name,e.target.value);i.showHint=!1,(a<t.min||a>t.max)&&(i.showHint=!0)}.bind(this)});
},{"../../../utils":47,"riot":58,"riotcontrol":59}],40:[function(require,module,exports){
var riot=require("riot");riot.tag("ringform",'<h2>{ opts.action == \'newring\' ? \'New Ring\' : \'Control\' }</h2> <form name="frmRing" onsubmit="{ saveRing }"> <div riot-tag="ringid" if="{ opts.action == \'control\' }"></div> <div riot-tag="species"></div> <div if="{ opts.action == \'newring\' }"> <div> <label>Ring #</label><br> <input riot-type={"number"} name="ringNumber" step="1" min="0" max="99" required> </div> <div riot-tag="ringsize"></div> </div> <div> <label>Net</label><br> <input type="text" name="net"> </div> <div riot-tag="button-input" label="Age" options="{ age }"></div> <div riot-tag="button-input" label="Sex" options="{ sex }"></div> <div> <label>PJM</label><br> <input riot-type={"number"} step="1" min="0" max="9" name="pjm"> </div> <div> <label>Fat</label><br> <input riot-type={"number"} step="1" min="0" max="9" name="fat"> </div> <div riot-tag="dropdown" label="sign" require="required"> <option each="{ parent.ringers }" value="{ sign }">{ sign }</option> </div> <div riot-tag="minmax" label="weight" min="{data.MinVikt}" max="{data.MaxVikt}" unit="g"> <span>Avg. weight is</span> </div> <div riot-tag="minmax" label="wing" min="{data.MinVinge}" max="{data.MaxVinge}" unit="mm"> <span>Avg. wing length is</span> </div> <div> <label>Primaries</label><br> <input type="text" name="primaries" autocomplete="off"> </div> <div> <label>Secondaries</label><br> <input type="text" name="secondaries" autocomplete="off"> </div> <div> <label>Comment</label><br> <textarea name="comment" autocomplete="off"></textarea> </div> <div> <button type="submit">Save</button> <button type="button" onclick="{ resetForm }">Reset</button> </div> </form>',function(i){var e=require("riotcontrol"),t=require("form-serialize"),n=this;n.sex=[{label:"F",value:"F"},{label:"M",value:"M"}],n.age=[{label:"1.0",value:"1.0"},{label:"2.0",value:"2.0"},{label:"2+",value:"2+"},{label:"3+",value:"3+"}],this.setRingformData=function(e){n.update({data:e}),"newring"==i.action&&n.tags.ringsize.setRingsize(e.Rtyp1.replace(",","."))}.bind(this),this.saveRing=function(){var r=t(n.frmRing,{hash:!0});if("newring"==i.action){if(!r.ringSize)return void e.trigger("alert","Ring size missing. Unable to create unique ring id.","error");r.ringNumber=parseInt(r.ringNumber)<10?"0"+r.ringNumber:r.ringNumber,r.id=r.snid?r.snid+r.ringNumber:r.ringNumber}r.species=r.species.toUpperCase(),delete r.ringNumber,delete r.ringSize,delete r.snid,e.trigger("ringform_save",i.action,r)}.bind(this),this.resetForm=function(){n.frmRing.reset()}.bind(this),e.on("ringers_data",function(i){n.update({ringers:i})}),e.on("ringform_reset",n.resetForm)});
...
var riot=require("riot");riot.tag("ringsize",'<input type="hidden" name="snid"> <div riot-tag="dropdown" label="ringSize" require="required"> <option each="{ ringsize }" value="{ size }">{ size }</option> </div>',function(){var i=require("riotcontrol"),n=this;this.setRingsize=function(e){parent.frmRing.ringSize.value=e;var r=parent.frmRing.ringSize.selectedIndex;if(-1==r){var t="Suggested ring size ("+e+") not listed in Rings.";return void i.trigger("alert",t,"warning")}n.setSnid(e)}.bind(this),this.setSnid=function(i){n.ringsize.forEach(function(e){e.size==i&&(n.snid.value=e.snid)})}.bind(this),i.on("ringlist_data",function(i){console.log("got ringlist data",i),n.update({ringsize:i})})});
...
var riot=require("riot");riot.tag("ringlist",'<a href onclick="{ toggleForm }">Toggle Rings</a> <div if="{ showForm }"> <h3>Rings</h3> <div each="{ rings }"> <span>{ size }, { snid }</span> <button type="button" onclick="{ parent.removeSize }">X</button> </div> <form name="frmRinglist" onsubmit="{ saveSize }"> <label>Size</label><br> <input riot-type={"number"} step="0.5" name="size" placeholder="Ring size" autocomplete="off" required><br> <label>Serial number</label><br> <input type="text" name="snid" placeholder="Serial number" autocomplete="off" required><br> <button type="submit">Save</button> <button type="button" onclick="{ resetForm }">Cancel</button> </form> </div>',function(){var i=require("riotcontrol"),e=this;this.toggleForm=function(){e.showForm=!e.showForm}.bind(this),this.saveSize=function(){var t={size:e.size.value,snid:e.snid.value.toUpperCase()};i.trigger("ringlist_add",t),e.frmRinglist.reset(),e.size.focus()}.bind(this),this.removeSize=function(e){i.trigger("ringlist_remove",e.item)}.bind(this),this.resetForm=function(){e.frmRinglist.reset(),e.toggleForm()}.bind(this),i.on("ringlist_data",function(i){e.update({rings:i})}),i.on("ringlist_hide",function(){e.update({showForm:!1})})});
